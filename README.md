...
* [hyperlearn](https://github.com/danielhanchen/hyperlearn) ⭐ 2,507 | 🐛 2 | 🌐 Jupyter Notebook | 📅 2024-11-19 - 50%+ Faster, 50%+ less RAM usage, GPU support re-written Sklearn, Statsmodels. <img height="20" src="img/sklearn_big.png" alt="sklearn"> <img height="20" src="img/pytorch_big2.png" alt="PyTorch based/compatible">
...
* [NLTK](https://github.com/nltk/nltk) ⭐ 14,706 | 🐛 242 | 🌐 Python | 📅 2026-08-28 -  Modules, data sets, and tutorials supporting research and development in Natural Language Processing.
...
* [torchaudio](https://github.com/pytorch/audio) ⭐ 2,931 | 🐛 338 | 🌐 Python | 📅 2026-08-28 - An audio library for PyTorch. <img height="20" src="img/pytorch_big2.png" alt="PyTorch based/compatible">
...
* [skforecast](https://github.com/JoaquinAmatRodrigo/skforecast) ⭐ 1,529 | 🐛 11 | 🌐 Python | 📅 2026-08-28 - Time series forecasting with machine learning models
...
* [EnvPool](https://github.com/sail-sg/envpool) ⭐ 1,512 | 🐛 16 | 🌐 C++ | 📅 2026-08-28 - C++-based high-performance parallel environment execution engine (vectorized env) for general RL environments.
...
* [pgmpy](https://github.com/pgmpy/pgmpy) ⭐ 3,320 | 🐛 631 | 🌐 Python | 📅 2026-08-19 - A python library for working with Probabilistic Graphical Models.
* [pyAgrum](https://agrum.gitlab.io/) - A GRaphical Universal Modeler.

## Probabilistic Methods

* [PyMC](https://github.com/pymc-devs/pymc) ⭐ 9,728 | 🐛 491 | 🌐 Python | 📅 2026-08-24 - Bayesian Stochastic Modelling in Python.
...
* [ELI5](https://github.com/TeamHG-Memex/eli5) ⭐ 2,806 | 🐛 162 | 🌐 Jupyter Notebook | 📅 2026-04-08 - A library for debugging/inspecting machine learning classifiers and explaining their predictions.
...
* [Optuna](https://github.com/optuna/optuna) ⭐ 14,722 | 🐛 21 | 🌐 Python | 📅 2026-08-27 - A hyperparameter optimization framework.
...
* [tsfresh](https://github.com/blue-yonder/tsfresh) ⭐ 9,301 | 🐛 74 | 🌐 Jupyter Notebook | 📅 2026-07-06 - Automatic extraction of relevant features from time series. <img height="20" src="img/sklearn_big.png" alt="sklearn">
...
* [Bokeh](https://github.com/bokeh/bokeh) ⭐ 20,437 | 🐛 845 | 🌐 Python | 📅 2026-08-29 - Interactive Web Plotting for Python.
* [pyecharts](https://github.com/pyecharts/pyecharts) ⭐ 15,777 | 🐛 4 | 🌐 Python | 📅 2026-08-04 - Migrated from [Echarts](https://github.com/apache/echarts) ⭐ 67,174 | 🐛 1,525 | 🌐 TypeScript | 📅 2026-08-04, a charting and visualization library, to Python's interactive visual drawing library.<img height="20" src="img/pyecharts.png" alt="pyecharts"> <img height="20" src="img/echarts.png" alt="echarts">
...
* [HoloViews](https://github.com/ioam/holoviews) ⭐ 2,907 | 🐛 1,053 | 🌐 Python | 📅 2026-08-28 - Stop plotting your data - annotate your data and let it visualize itself.
...
* [xarray](https://github.com/pydata/xarray) ⭐ 4,191 | 🐛 1,423 | 🌐 Python | 📅 2026-08-28 - Xarray combines the best features of NumPy and pandas for multidimensional data selection by supplementing numerical axis labels with named dimensions for more intuitive, concise, and less error-prone indexing routines.
...
* [PaddlePaddle](https://github.com/PaddlePaddle/Paddle) ⭐ 24,062 | 🐛 1,507 | 🌐 C++ | 📅 2026-08-28 - PArallel Distributed Deep LEarning.
...
* [Distributed](https://github.com/dask/distributed) ⭐ 1,685 | 🐛 1,511 | 🌐 Python | 📅 2026-08-28 - Distributed computation in Python.
...
* [great\_expectations](https://github.com/great-expectations/great_expectations) ⭐ 11,745 | 🐛 31 | 🌐 Python | 📅 2026-08-28 - Always know what to expect from your data.
* [evidently](https://github.com/evidentlyai/evidently) ⭐ 7,861 | 🐛 299 | 🌐 Jupyter Notebook | 📅 2026-08-05 - Evaluate and monitor ML models from validation to production.
* [pandera](https://github.com/unionai-oss/pandera) ⭐ 4,444 | 🐛 446 | 🌐 Python | 📅 2026-08-27 - A lightweight, flexible, and expressive statistical data testing library.
...
* [DataComPy](https://github.com/capitalone/datacompy) ⭐ 658 | 🐛 12 | 🌐 Python | 📅 2026-08-28- A library to compare Pandas, Polars, and Spark data frames. It provides stats and lets users adjust for match accuracy.
...
* [Dask](https://github.com/dask/dask) ⭐ 13,901 | 🐛 1,317 | 🌐 Python | 📅 2026-08-24 - Parallel computing with task scheduling. <img height="20" src="img/pandas_big.png" alt="pandas compatible">
* [CuPy](https://github.com/cupy/cupy) ⭐ 12,285 | 🐛 709 | 🌐 Python | 📅 2026-08-28 - NumPy-like API accelerated with CUDA.
...
* [GeoPandas](https://github.com/geopandas/geopandas) ⭐ 5,233 | 🐛 429 | 🌐 Python | 📅 2026-08-28 - Python tools for geographic data. <img height="20" src="img/pandas_big.png" alt="pandas compatible">
