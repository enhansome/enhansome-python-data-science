...
* [PyCaret](https://github.com/pycaret/pycaret) ⭐ 9,846 | 🐛 34 | 🌐 Python | 📅 2026-07-23 - An open-source, low-code machine learning library in Python.  <img height="20" src="img/R_big.png" alt="R inspired lib">
...
* [cuML](https://github.com/rapidsai/cuml) ⭐ 5,290 | 🐛 806 | 🌐 Python | 📅 2026-09-24 - RAPIDS Machine Learning Library. <img height="20" src="img/sklearn_big.png" alt="sklearn"> <img height="20" src="img/gpu_big.png" alt="GPU accelerated">
* [MLxtend](https://github.com/rasbt/mlxtend) ⭐ 5,176 | 🐛 138 | 🌐 Python | 📅 2026-09-25 - Extension and helper modules for Python's data analysis and machine learning libraries. <img height="20" src="img/sklearn_big.png" alt="sklearn">
...
* [XGBoost](https://github.com/dmlc/xgboost) ⭐ 28,793 | 🐛 441 | 🌐 C++ | 📅 2026-09-25 - Scalable, Portable, and Distributed Gradient Boosting. <img height="20" src="img/sklearn_big.png" alt="sklearn"> <img height="20" src="img/gpu_big.png" alt="GPU accelerated">
* [LightGBM](https://github.com/Microsoft/LightGBM) ⭐ 18,813 | 🐛 522 | 🌐 C++ | 📅 2026-09-25 - A fast, distributed, high-performance gradient boosting. <img height="20" src="img/sklearn_big.png" alt="sklearn"> <img height="20" src="img/gpu_big.png" alt="GPU accelerated">
* [CatBoost](https://github.com/catboost/catboost) ⭐ 9,117 | 🐛 724 | 🌐 C++ | 📅 2026-09-25 - An open-source gradient boosting on decision trees library. <img height="20" src="img/sklearn_big.png" alt="sklearn"> <img height="20" src="img/gpu_big.png" alt="GPU accelerated">
...
* [PyTorch](https://github.com/pytorch/pytorch) ⭐ 103,320 | 🐛 17,568 | 🌐 Python | 📅 2026-09-25 - Tensors and Dynamic neural networks in Python with strong GPU acceleration. <img height="20" src="img/pytorch_big2.png" alt="PyTorch based/compatible">
* [pytorch-lightning](https://github.com/Lightning-AI/lightning) ⭐ 31,361 | 🐛 1,088 | 🌐 Python | 📅 2026-09-21 - PyTorch Lightning is just organized PyTorch. <img height="20" src="img/pytorch_big2.png" alt="PyTorch based/compatible">
...
* [TensorFlow](https://github.com/tensorflow/tensorflow) ⭐ 200,311 | 🐛 3,311 | 🌐 C++ | 📅 2026-09-25 - Computation using data flow graphs for scalable machine learning by Google. <img height="20" src="img/tf_big2.png" alt="sklearn">
...
* [JAX](https://github.com/google/jax) ⭐ 36,339 | 🐛 2,592 | 🌐 Python | 📅 2026-09-25 - Composable transformations of Python+NumPy programs: differentiate, vectorize, JIT to GPU/TPU, and more.
* [FLAX](https://github.com/google/flax) ⭐ 7,333 | 🐛 521 | 🌐 Jupyter Notebook | 📅 2026-09-25 - A neural network library for JAX that is designed for flexibility.
...
* [transformers](https://github.com/huggingface/transformers) ⭐ 166,655 | 🐛 2,381 | 🌐 Python | 📅 2026-09-25 - State-of-the-art Machine Learning for Pytorch, TensorFlow, and JAX. <img height="20" src="img/pytorch_big2.png" alt="PyTorch based/compatible"> <img height="20" src="img/tf_big2.png" alt="sklearn">
...
* [AutoGluon](https://github.com/awslabs/autogluon) ⭐ 10,748 | 🐛 377 | 🌐 Python | 📅 2026-09-25 - AutoML for Image, Text, Tabular, Time-Series, and MultiModal Data.
...
* [NLTK](https://github.com/nltk/nltk) ⭐ 14,727 | 🐛 260 | 🌐 Python | 📅 2026-09-24 -  Modules, data sets, and tutorials supporting research and development in Natural Language Processing.
...
* [librosa](https://github.com/librosa/librosa) ⭐ 8,630 | 🐛 52 | 🌐 Python | 📅 2026-09-24 - Python library for audio and music analysis.
* [aubio](https://github.com/aubio/aubio) ⭐ 3,760 | 🐛 160 | 🌐 C | 📅 2026-04-10 - A library for audio and music analysis.
* [Essentia](https://github.com/MTG/essentia) ⭐ 3,743 | 🐛 440 | 🌐 C++ | 📅 2026-09-21 - Library for audio and music analysis, description, and synthesis.
* [torchaudio](https://github.com/pytorch/audio) ⭐ 2,946 | 🐛 342 | 🌐 Python | 📅 2026-09-25 - An audio library for PyTorch. <img height="20" src="img/pytorch_big2.png" alt="PyTorch based/compatible">
...
* [OpenCV](https://github.com/opencv/opencv) ⭐ 90,962 | 🐛 2,770 | 🌐 C++ | 📅 2026-09-25 - Open Source Computer Vision Library.
* [torchvision](https://github.com/pytorch/vision) ⭐ 17,926 | 🐛 1,227 | 🌐 Python | 📅 2026-09-25 - Datasets, Transforms, and Models specific to Computer Vision. <img height="20" src="img/pytorch_big2.png" alt="PyTorch based/compatible">
...
* [PyTorch3D](https://github.com/facebookresearch/pytorch3d) ⭐ 9,970 | 🐛 312 | 🌐 Python | 📅 2026-09-15 - PyTorch3D is FAIR's library of reusable components for deep learning with 3D data. <img height="20" src="img/pytorch_big2.png" alt="PyTorch based/compatible">
...
* [Prophet](https://github.com/facebook/prophet) ⭐ 20,418 | 🐛 455 | 🌐 Python | 📅 2026-08-27 - Automatic Forecasting Procedure.
* [sktime](https://github.com/alan-turing-institute/sktime) ⭐ 10,045 | 🐛 2,520 | 🌐 Python | 📅 2026-09-25 - A unified framework for machine learning with time series. <img height="20" src="img/sklearn_big.png" alt="sklearn">
* [darts](https://github.com/unit8co/darts) ⭐ 9,525 | 🐛 221 | 🌐 Python | 📅 2026-09-25 - A python library for easy manipulation and forecasting of time series.
* [statsforecast](https://github.com/Nixtla/statsforecast) ⭐ 4,914 | 🐛 152 | 🌐 Python | 📅 2026-09-21 - Lightning fast forecasting with statistical and econometric models.
...
* [skforecast](https://github.com/JoaquinAmatRodrigo/skforecast) ⭐ 1,537 | 🐛 13 | 🌐 Python | 📅 2026-09-25 - Time series forecasting with machine learning models
* [mlforecast](https://github.com/Nixtla/mlforecast) ⭐ 1,282 | 🐛 22 | 🌐 Python | 📅 2026-09-25 - Scalable machine learning-based time series forecasting.
...
* [Tianshou](https://github.com/thu-ml/tianshou/#comprehensive-functionality) ⭐ 10,991 | 🐛 142 | 🌐 Python | 📅 2026-04-03 - An elegant PyTorch deep reinforcement learning library. <img height="20" src="img/pytorch_big2.png" alt="PyTorch based/compatible">
...
* [pytorch\_geometric](https://github.com/rusty1s/pytorch_geometric) ⭐ 24,098 | 🐛 1,347 | 🌐 Python | 📅 2026-09-01 - Geometric Deep Learning Extension Library for PyTorch. <img height="20" src="img/pytorch_big2.png" alt="PyTorch based/compatible">
* [TRL](https://github.com/huggingface/trl) ⭐ 19,388 | 🐛 287 | 🌐 Python | 📅 2026-09-25 - Train transformer language models with reinforcement learning.
...
* [Networkx](https://github.com/networkx/networkx) ⭐ 17,287 | 🐛 306 | 🌐 Python | 📅 2026-09-25 - Network Analysis in Python.
...
* [RecBole](https://github.com/RUCAIBox/RecBole) ⭐ 4,568 | 🐛 359 | 🌐 Python | 📅 2025-02-24 - A unified, comprehensive and efficient recommendation library. <img height="20" src="img/pytorch_big2.png" alt="PyTorch based/compatible">
...
* [pgmpy](https://github.com/pgmpy/pgmpy) ⭐ 3,339 | 🐛 637 | 🌐 Python | 📅 2026-09-25 - A python library for working with Probabilistic Graphical Models.
* [pyAgrum](https://agrum.gitlab.io/) - A GRaphical Universal Modeler.

## Probabilistic Methods

* [PyMC](https://github.com/pymc-devs/pymc) ⭐ 9,773 | 🐛 515 | 🌐 Python | 📅 2026-09-21 - Bayesian Stochastic Modelling in Python.
...
* [skpro](https://github.com/alan-turing-institute/skpro) ⭐ 336 | 🐛 266 | 🌐 Python | 📅 2026-09-25 - Supervised domain-agnostic prediction framework for probabilistic modelling by [The Alan Turing Institute](https://www.turing.ac.uk/). <img height="20" src="img/sklearn_big.png" alt="sklearn">
...
* [Netron](https://github.com/lutzroeder/Netron) ⭐ 33,524 | 🐛 18 | 🌐 JavaScript | 📅 2026-09-25 - Visualizer for deep learning and machine learning models (no Python code, but visualizes models from most Python Deep Learning frameworks).
* [shap](https://github.com/slundberg/shap) ⭐ 25,783 | 🐛 981 | 🌐 Jupyter Notebook | 📅 2026-09-25 - A unified approach to explain the output of any machine learning model. <img height="20" src="img/sklearn_big.png" alt="sklearn">
...
* [PyGAD](https://github.com/ahmedfgad/GeneticAlgorithmPython) ⭐ 2,225 | 🐛 103 | 🌐 Python | 📅 2026-07-09 - Genetic Algorithm in Python. <img height="20" src="img/pytorch_big2.png" alt="PyTorch based/compatible"> <img height="20" src="img/keras_big.png" alt="keras">
...
* [Optuna](https://github.com/optuna/optuna) ⭐ 14,846 | 🐛 17 | 🌐 Python | 📅 2026-09-25 - A hyperparameter optimization framework.
* [Bayesian Optimization](https://github.com/fmfn/BayesianOptimization) ⭐ 8,713 | 🐛 8 | 🌐 Python | 📅 2026-08-21 - A Python implementation of global optimization with gaussian processes.
...
* [BoTorch](https://github.com/pytorch/botorch) ⭐ 3,602 | 🐛 96 | 🌐 Jupyter Notebook | 📅 2026-09-23 - Bayesian optimization in PyTorch. <img height="20" src="img/pytorch_big2.png" alt="PyTorch based/compatible">
...
* [SMAC3](https://github.com/automl/SMAC3) ⭐ 1,251 | 🐛 112 | 🌐 Python | 📅 2026-09-25 - Sequential Model-based Algorithm Configuration.
...
* [tubular](https://github.com/azukds/tubular) ⭐ 108 | 🐛 71 | 🌐 Python | 📅 2026-09-23 - Collection of scikit-learn compatible transformers written in [narwhals](https://github.com/narwhals-dev/narwhals) ⭐ 1,723 | 🐛 262 | 🌐 Python | 📅 2026-09-25, which can accept either polars/pandas inputs and utilise the chosen library under the hood. <img height="20" src="img/sklearn_big.png" alt="sklearn"><img height="20" src="img/pandas_big.png" alt="pandas compatible">
...
* [Matplotlib](https://github.com/matplotlib/matplotlib) ⭐ 23,269 | 🐛 1,488 | 🌐 Python | 📅 2026-09-25 - Plotting with Python.
...
* [Bokeh](https://github.com/bokeh/bokeh) ⭐ 20,460 | 🐛 845 | 🌐 TypeScript | 📅 2026-09-25 - Interactive Web Plotting for Python.
* [pyecharts](https://github.com/pyecharts/pyecharts) ⭐ 15,771 | 🐛 4 | 🌐 Python | 📅 2026-08-04 - Migrated from [Echarts](https://github.com/apache/echarts) ⭐ 67,395 | 🐛 1,492 | 🌐 TypeScript | 📅 2026-09-16, a charting and visualization library, to Python's interactive visual drawing library.<img height="20" src="img/pyecharts.png" alt="pyecharts"> <img height="20" src="img/echarts.png" alt="echarts">
...
* [HoloViews](https://github.com/ioam/holoviews) ⭐ 2,910 | 🐛 1,021 | 🌐 Python | 📅 2026-09-25 - Stop plotting your data - annotate your data and let it visualize itself.
...
* [gradio](https://github.com/gradio-app/gradio) ⭐ 43,625 | 🐛 84 | 🌐 Python | 📅 2026-09-25 - Create UIs for your machine learning model in Python in 3 minutes.
* [Vizro](https://github.com/mckinsey/vizro) ⭐ 3,798 | 🐛 37 | 🌐 Python | 📅 2026-09-25 - A toolkit for creating modular data visualization applications.
* [Deepnote](https://github.com/deepnote/deepnote) ⭐ 3,009 | 🐛 41 | 🌐 TypeScript | 📅 2026-09-25 - Deepnote is a drop-in replacement for Jupyter with an AI-first design, sleek UI, new blocks, and native data integrations. Use Python, R, and SQL locally in your favorite IDE, then scale to Deepnote cloud for real-time collaboration, Deepnote agent, and deployable data apps.
...
* [statsmodels](https://github.com/statsmodels/statsmodels) ⭐ 11,652 | 🐛 2,824 | 🌐 Python | 📅 2026-09-25 - Statistical modeling and econometrics in Python.
...
* [polars](https://github.com/pola-rs/polars) ⭐ 39,862 | 🐛 2,933 | 🌐 Rust | 📅 2026-09-25 - A fast multi-threaded, hybrid-out-of-core DataFrame library.
...
* [cuDF](https://github.com/rapidsai/cudf) ⭐ 9,764 | 🐛 1,361 | 🌐 C++ | 📅 2026-09-25 - GPU DataFrame Library. <img height="20" src="img/pandas_big.png" alt="pandas compatible"> <img height="20" src="img/gpu_big.png" alt="GPU accelerated">
...
* [xarray](https://github.com/pydata/xarray) ⭐ 4,200 | 🐛 1,461 | 🌐 Python | 📅 2026-09-25 - Xarray combines the best features of NumPy and pandas for multidimensional data selection by supplementing numerical axis labels with named dimensions for more intuitive, concise, and less error-prone indexing routines.
...
* [Hamilton](https://github.com/DAGWorks-Inc/hamilton) ⭐ 2,599 | 🐛 161 | 🌐 Jupyter Notebook | 📅 2026-09-25 - A microframework for dataframe generation that applies Directed Acyclic Graphs specified by a flow of lazily evaluated Python functions.
* [pyjanitor](https://github.com/ericmjl/pyjanitor) ⭐ 1,500 | 🐛 147 | 🌐 Python | 📅 2026-09-25 - Clean APIs for data cleaning. <img height="20" src="img/pandas_big.png" alt="pandas compatible">
...
* [cleanlab](https://github.com/cleanlab/cleanlab) ⭐ 11,674 | 🐛 124 | 🌐 Python | 📅 2026-01-13 - The standard data-centric AI package for data quality and machine learning with messy, real-world data and labels.
...
* [Distributed](https://github.com/dask/distributed) ⭐ 1,693 | 🐛 1,520 | 🌐 Python | 📅 2026-09-25 - Distributed computation in Python.
...
* [mlflow](https://github.com/mlflow/mlflow) ⭐ 28,138 | 🐛 2,130 | 🌐 Python | 📅 2026-09-25 - Open source platform for the machine learning lifecycle.
* [dvc](https://github.com/iterative/dvc) ⭐ 15,886 | 🐛 214 | 🌐 Python | 📅 2026-09-21 - Data Version Control | Git for Data & Models | ML Experiments Management.
...
* [Ax](https://github.com/facebook/Ax) ⭐ 2,813 | 🐛 185 | 🌐 Python | 📅 2026-09-21 - Adaptive Experimentation Platform. <img height="20" src="img/sklearn_big.png" alt="sklearn">
...
* [great\_expectations](https://github.com/great-expectations/great_expectations) ⭐ 11,841 | 🐛 68 | 🌐 Python | 📅 2026-09-25 - Always know what to expect from your data.
* [evidently](https://github.com/evidentlyai/evidently) ⭐ 7,940 | 🐛 318 | 🌐 Jupyter Notebook | 📅 2026-09-11 - Evaluate and monitor ML models from validation to production.
* [pandera](https://github.com/unionai-oss/pandera) ⭐ 4,466 | 🐛 455 | 🌐 Python | 📅 2026-09-22 - A lightweight, flexible, and expressive statistical data testing library.
...
* [DataComPy](https://github.com/capitalone/datacompy) ⭐ 659 | 🐛 11 | 🌐 Python | 📅 2026-09-25- A library to compare Pandas, Polars, and Spark data frames. It provides stats and lets users adjust for match accuracy.
...
* [Dask](https://github.com/dask/dask) ⭐ 13,926 | 🐛 1,341 | 🌐 Python | 📅 2026-08-24 - Parallel computing with task scheduling. <img height="20" src="img/pandas_big.png" alt="pandas compatible">
...
* [qiskit](https://github.com/Qiskit/qiskit) ⭐ 7,831 | 🐛 1,029 | 🌐 Python | 📅 2026-09-25 - Qiskit is an open-source SDK for working with quantum computers at the level of circuits, algorithms, and application modules.
* [cirq](https://github.com/quantumlib/Cirq) ⭐ 5,070 | 🐛 125 | 🌐 Python | 📅 2026-09-25 - A python framework for creating, editing, and invoking Noisy Intermediate Scale Quantum (NISQ) circuits.
* [PennyLane](https://github.com/XanaduAI/pennylane) ⭐ 3,476 | 🐛 447 | 🌐 Python | 📅 2026-09-25 - Quantum machine learning, automatic differentiation, and optimization of hybrid quantum-classical computations.
* [QML](https://github.com/qmlcode/qml) ⚠️ Archived - A Python Toolkit for Quantum Machine Learning.

## Conversion

* [ONNX](https://github.com/onnx/onnx) ⭐ 21,526 | 🐛 243 | 🌐 Python | 📅 2026-09-25 - Open Neural Network Exchange.
