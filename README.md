...
* [PyCaret](https://github.com/pycaret/pycaret) ⭐ 9,843 | 🐛 34 | 🌐 Python | 📅 2026-07-23 - An open-source, low-code machine learning library in Python.  <img height="20" src="img/R_big.png" alt="R inspired lib">
* [causalml](https://github.com/uber/causalml) ⭐ 6,004 | 🐛 21 | 🌐 Python | 📅 2026-08-20 - Uplift modeling and causal inference with machine learning algorithms. <img height="20" src="img/sklearn_big.png" alt="sklearn">
* [mlpack](https://github.com/mlpack/mlpack) ⭐ 5,711 | 🐛 12 | 🌐 C++ | 📅 2026-09-17 - A scalable C++ machine learning library (Python bindings).
* [cuML](https://github.com/rapidsai/cuml) ⭐ 5,286 | 🐛 794 | 🌐 Python | 📅 2026-09-21 - RAPIDS Machine Learning Library. <img height="20" src="img/sklearn_big.png" alt="sklearn"> <img height="20" src="img/gpu_big.png" alt="GPU accelerated">
* [MLxtend](https://github.com/rasbt/mlxtend) ⭐ 5,175 | 🐛 141 | 🌐 Python | 📅 2026-09-18 - Extension and helper modules for Python's data analysis and machine learning libraries. <img height="20" src="img/sklearn_big.png" alt="sklearn">
...
* [XGBoost](https://github.com/dmlc/xgboost) ⭐ 28,784 | 🐛 435 | 🌐 C++ | 📅 2026-09-21 - Scalable, Portable, and Distributed Gradient Boosting. <img height="20" src="img/sklearn_big.png" alt="sklearn"> <img height="20" src="img/gpu_big.png" alt="GPU accelerated">
* [LightGBM](https://github.com/Microsoft/LightGBM) ⭐ 18,793 | 🐛 523 | 🌐 C++ | 📅 2026-09-21 - A fast, distributed, high-performance gradient boosting. <img height="20" src="img/sklearn_big.png" alt="sklearn"> <img height="20" src="img/gpu_big.png" alt="GPU accelerated">
* [CatBoost](https://github.com/catboost/catboost) ⭐ 9,112 | 🐛 724 | 🌐 C++ | 📅 2026-09-21 - An open-source gradient boosting on decision trees library. <img height="20" src="img/sklearn_big.png" alt="sklearn"> <img height="20" src="img/gpu_big.png" alt="GPU accelerated">
...
* [PyTorch](https://github.com/pytorch/pytorch) ⭐ 103,156 | 🐛 17,528 | 🌐 Python | 📅 2026-09-21 - Tensors and Dynamic neural networks in Python with strong GPU acceleration. <img height="20" src="img/pytorch_big2.png" alt="PyTorch based/compatible">
* [pytorch-lightning](https://github.com/Lightning-AI/lightning) ⭐ 31,356 | 🐛 1,085 | 🌐 Python | 📅 2026-09-21 - PyTorch Lightning is just organized PyTorch. <img height="20" src="img/pytorch_big2.png" alt="PyTorch based/compatible">
...
* [TensorFlow](https://github.com/tensorflow/tensorflow) ⭐ 200,231 | 🐛 3,232 | 🌐 C++ | 📅 2026-09-21 - Computation using data flow graphs for scalable machine learning by Google. <img height="20" src="img/tf_big2.png" alt="sklearn">
* [Ludwig](https://github.com/uber/ludwig) ⭐ 11,762 | 🐛 1 | 🌐 Python | 📅 2026-09-21 - A toolbox that allows one to train and test deep learning models without the need to write code. <img height="20" src="img/tf_big2.png" alt="sklearn">
...
* [tensorflow-upstream](https://github.com/ROCmSoftwarePlatform/tensorflow-upstream) ⭐ 706 | 🐛 95 | 🌐 C++ | 📅 2026-09-21 - TensorFlow ROCm port. <img height="20" src="img/tf_big2.png" alt="sklearn"> <img height="20" src="img/amd_big.png" alt="Possible to run on AMD GPU">
...
* [JAX](https://github.com/google/jax) ⭐ 36,321 | 🐛 2,591 | 🌐 Python | 📅 2026-09-21 - Composable transformations of Python+NumPy programs: differentiate, vectorize, JIT to GPU/TPU, and more.
* [FLAX](https://github.com/google/flax) ⭐ 7,328 | 🐛 522 | 🌐 Jupyter Notebook | 📅 2026-09-16 - A neural network library for JAX that is designed for flexibility.
* [Optax](https://github.com/google-deepmind/optax) ⭐ 2,340 | 🐛 126 | 🌐 Python | 📅 2026-09-14 - A gradient processing and optimization library for JAX.
...
* [transformers](https://github.com/huggingface/transformers) ⭐ 166,480 | 🐛 2,415 | 🌐 Python | 📅 2026-09-21 - State-of-the-art Machine Learning for Pytorch, TensorFlow, and JAX. <img height="20" src="img/pytorch_big2.png" alt="PyTorch based/compatible"> <img height="20" src="img/tf_big2.png" alt="sklearn">
* [Caffe](https://github.com/BVLC/caffe) ⭐ 34,552 | 🐛 1,175 | 🌐 C++ | 📅 2024-07-31 - A fast open framework for deep learning.
* [autograd](https://github.com/HIPS/autograd) ⭐ 7,531 | 🐛 187 | 🌐 Python | 📅 2026-09-21 - Efficiently computes derivatives of numpy code.
...
* [AutoGluon](https://github.com/awslabs/autogluon) ⭐ 10,728 | 🐛 381 | 🌐 Python | 📅 2026-09-21 - AutoML for Image, Text, Tabular, Time-Series, and MultiModal Data.
...
* [auto-sklearn](https://github.com/automl/auto-sklearn) ⭐ 8,133 | 🐛 209 | 🌐 Python | 📅 2026-09-15 - An AutoML toolkit and a drop-in replacement for a scikit-learn estimator. <img height="20" src="img/sklearn_big.png" alt="sklearn">
...
* [NLTK](https://github.com/nltk/nltk) ⭐ 14,722 | 🐛 258 | 🌐 Python | 📅 2026-09-21 -  Modules, data sets, and tutorials supporting research and development in Natural Language Processing.
* [flair](https://github.com/zalandoresearch/flair) ⭐ 14,389 | 🐛 31 | 🌐 Python | 📅 2025-10-27 - Very simple framework for state-of-the-art NLP.
...
* [KerasNLP](https://github.com/keras-team/keras-nlp) ⭐ 990 | 🐛 257 | 🌐 Python | 📅 2026-09-21 - Modular Natural Language Processing workflows with Keras. <img height="20" src="img/keras_big.png" alt="Keras based/compatible">
...
* [librosa](https://github.com/librosa/librosa) ⭐ 8,619 | 🐛 51 | 🌐 Python | 📅 2026-09-21 - Python library for audio and music analysis.
* [aubio](https://github.com/aubio/aubio) ⭐ 3,756 | 🐛 160 | 🌐 C | 📅 2026-04-10 - A library for audio and music analysis.
* [Essentia](https://github.com/MTG/essentia) ⭐ 3,733 | 🐛 439 | 🌐 C++ | 📅 2026-09-21 - Library for audio and music analysis, description, and synthesis.
* [torchaudio](https://github.com/pytorch/audio) ⭐ 2,944 | 🐛 340 | 🌐 Python | 📅 2026-09-21 - An audio library for PyTorch. <img height="20" src="img/pytorch_big2.png" alt="PyTorch based/compatible">
...
* [OpenCV](https://github.com/opencv/opencv) ⭐ 90,916 | 🐛 2,771 | 🌐 C++ | 📅 2026-09-21 - Open Source Computer Vision Library.
* [torchvision](https://github.com/pytorch/vision) ⭐ 17,925 | 🐛 1,223 | 🌐 Python | 📅 2026-09-21 - Datasets, Transforms, and Models specific to Computer Vision. <img height="20" src="img/pytorch_big2.png" alt="PyTorch based/compatible">
...
* [imgaug](https://github.com/aleju/imgaug) ⭐ 14,739 | 🐛 310 | 🌐 Python | 📅 2024-07-30 - Image augmentation for machine learning experiments.
...
* [scikit-image](https://github.com/scikit-image/scikit-image) ⭐ 6,594 | 🐛 955 | 🌐 Python | 📅 2026-09-21 - Image Processing SciKit (Toolbox for SciPy).
...
* [Decord](https://github.com/dmlc/decord) ⭐ 2,520 | 🐛 221 | 🌐 C++ | 📅 2024-07-17 - An efficient video loader for deep learning with smart shuffling that's super easy to digest.
...
* [Prophet](https://github.com/facebook/prophet) ⭐ 20,412 | 🐛 455 | 🌐 Python | 📅 2026-08-27 - Automatic Forecasting Procedure.
* [sktime](https://github.com/alan-turing-institute/sktime) ⭐ 10,027 | 🐛 2,491 | 🌐 Python | 📅 2026-09-21 - A unified framework for machine learning with time series. <img height="20" src="img/sklearn_big.png" alt="sklearn">
...
* [statsforecast](https://github.com/Nixtla/statsforecast) ⭐ 4,912 | 🐛 150 | 🌐 Python | 📅 2026-09-21 - Lightning fast forecasting with statistical and econometric models.
* [neuralforecast](https://github.com/Nixtla/neuralforecast) ⭐ 4,275 | 🐛 14 | 🌐 Python | 📅 2026-09-21 - Scalable machine learning-based time series forecasting.
...
* [tslearn](https://github.com/rtavenar/tslearn) ⭐ 3,179 | 🐛 80 | 🌐 Python | 📅 2026-09-21 - Machine learning toolkit dedicated to time-series data. <img height="20" src="img/sklearn_big.png" alt="sklearn">
...
* [skforecast](https://github.com/JoaquinAmatRodrigo/skforecast) ⭐ 1,535 | 🐛 13 | 🌐 Python | 📅 2026-09-21 - Time series forecasting with machine learning models
* [mlforecast](https://github.com/Nixtla/mlforecast) ⭐ 1,279 | 🐛 18 | 🌐 Python | 📅 2026-09-21 - Scalable machine learning-based time series forecasting.
...
* [Stable Baselines3](https://github.com/DLR-RM/stable-baselines3) ⭐ 13,829 | 🐛 89 | 🌐 Python | 📅 2026-09-09 - A set of improved implementations of reinforcement learning algorithms based on OpenAI Baselines.
* [Gymnasium](https://github.com/Farama-Foundation/Gymnasium) ⭐ 12,559 | 🐛 90 | 🌐 Python | 📅 2026-09-21 - An API standard for single-agent reinforcement learning environments, with popular reference environments and related utilities (formerly [Gym](https://github.com/openai/gym) ⚠️ Archived).
* [Tianshou](https://github.com/thu-ml/tianshou/#comprehensive-functionality) ⭐ 10,988 | 🐛 141 | 🌐 Python | 📅 2026-04-03 - An elegant PyTorch deep reinforcement learning library. <img height="20" src="img/pytorch_big2.png" alt="PyTorch based/compatible">
...
* [cleanrl](https://github.com/vwxyzjn/cleanrl) ⭐ 10,436 | 🐛 113 | 🌐 Python | 📅 2026-04-20 - High-quality single file implementation of Deep Reinforcement Learning algorithms with research-friendly features (PPO, DQN, C51, DDPG, TD3, SAC, PPG).
...
* [garage](https://github.com/rlworkgroup/garage) ⭐ 2,129 | 🐛 235 | 🌐 Python | 📅 2023-05-04 - A toolkit for reproducible reinforcement learning research.
* [Imitation](https://github.com/HumanCompatibleAI/imitation) ⭐ 1,798 | 🐛 99 | 🌐 Python | 📅 2025-01-07 - Clean PyTorch implementations of imitation and reward learning algorithms. <img height="20" src="img/pytorch_big2.png" alt="PyTorch based/compatible">
...
* [MAgent2](https://github.com/Farama-Foundation/MAgent2) ⭐ 965 | 🐛 18 | 🌐 Python | 📅 2026-09-13 - An engine for high performance multi-agent environments with very large numbers of agents, along with a set of reference environments.
...
* [pytorch\_geometric](https://github.com/rusty1s/pytorch_geometric) ⭐ 24,099 | 🐛 1,342 | 🌐 Python | 📅 2026-09-01 - Geometric Deep Learning Extension Library for PyTorch. <img height="20" src="img/pytorch_big2.png" alt="PyTorch based/compatible">
* [TRL](https://github.com/huggingface/trl) ⭐ 19,357 | 🐛 282 | 🌐 Python | 📅 2026-09-21 - Train transformer language models with reinforcement learning.
...
* [Networkx](https://github.com/networkx/networkx) ⭐ 17,271 | 🐛 317 | 🌐 Python | 📅 2026-09-21 - Network Analysis in Python.
...
* [RecBole](https://github.com/RUCAIBox/RecBole) ⭐ 4,566 | 🐛 359 | 🌐 Python | 📅 2025-02-24 - A unified, comprehensive and efficient recommendation library. <img height="20" src="img/pytorch_big2.png" alt="PyTorch based/compatible">
...
* [pgmpy](https://github.com/pgmpy/pgmpy) ⭐ 3,333 | 🐛 641 | 🌐 Python | 📅 2026-09-16 - A python library for working with Probabilistic Graphical Models.
* [pyAgrum](https://agrum.gitlab.io/) - A GRaphical Universal Modeler.

## Probabilistic Methods

* [PyMC](https://github.com/pymc-devs/pymc) ⭐ 9,766 | 🐛 510 | 🌐 Python | 📅 2026-09-21 - Bayesian Stochastic Modelling in Python.
* [pyro](https://github.com/uber/pyro) ⭐ 9,057 | 🐛 293 | 🌐 Python | 📅 2026-09-07 - A flexible, scalable deep probabilistic programming library built on PyTorch. <img height="20" src="img/pytorch_big2.png" alt="PyTorch based/compatible">
* [GPyTorch](https://github.com/cornellius-gp/gpytorch) ⭐ 3,915 | 🐛 422 | 🌐 Python | 📅 2026-07-10 - A highly efficient and modular implementation of Gaussian Processes in PyTorch. <img height="20" src="img/pytorch_big2.png" alt="PyTorch based/compatible">
...
* [skpro](https://github.com/alan-turing-institute/skpro) ⭐ 336 | 🐛 266 | 🌐 Python | 📅 2026-09-21 - Supervised domain-agnostic prediction framework for probabilistic modelling by [The Alan Turing Institute](https://www.turing.ac.uk/). <img height="20" src="img/sklearn_big.png" alt="sklearn">
...
* [Netron](https://github.com/lutzroeder/Netron) ⭐ 33,505 | 🐛 18 | 🌐 JavaScript | 📅 2026-09-21 - Visualizer for deep learning and machine learning models (no Python code, but visualizes models from most Python Deep Learning frameworks).
* [shap](https://github.com/slundberg/shap) ⭐ 25,772 | 🐛 984 | 🌐 Jupyter Notebook | 📅 2026-09-21 - A unified approach to explain the output of any machine learning model. <img height="20" src="img/sklearn_big.png" alt="sklearn">
...
* [DEAP](https://github.com/DEAP/deap) ⭐ 6,441 | 🐛 281 | 🌐 Python | 📅 2026-04-17 - Distributed Evolutionary Algorithms in Python.
...
* [Optuna](https://github.com/optuna/optuna) ⭐ 14,829 | 🐛 21 | 🌐 Python | 📅 2026-09-18 - A hyperparameter optimization framework.
* [Bayesian Optimization](https://github.com/fmfn/BayesianOptimization) ⭐ 8,712 | 🐛 7 | 🌐 Python | 📅 2026-08-21 - A Python implementation of global optimization with gaussian processes.
...
* [BoTorch](https://github.com/pytorch/botorch) ⭐ 3,600 | 🐛 93 | 🌐 Jupyter Notebook | 📅 2026-09-08 - Bayesian optimization in PyTorch. <img height="20" src="img/pytorch_big2.png" alt="PyTorch based/compatible">
* [pymoo](https://github.com/anyoptimization/pymoo) ⭐ 2,961 | 🐛 0 | 🌐 Python | 📅 2026-07-07 - Multi-objective Optimization in Python.
* [POT](https://github.com/rflamary/POT) ⭐ 2,846 | 🐛 49 | 🌐 Python | 📅 2026-09-18 - Python Optimal Transport library.
...
* [SMAC3](https://github.com/automl/SMAC3) ⭐ 1,247 | 🐛 113 | 🌐 Python | 📅 2026-09-21 - Sequential Model-based Algorithm Configuration.
...
* [tsfresh](https://github.com/blue-yonder/tsfresh) ⭐ 9,426 | 🐛 74 | 🌐 Jupyter Notebook | 📅 2026-07-06 - Automatic extraction of relevant features from time series. <img height="20" src="img/sklearn_big.png" alt="sklearn">
* [Featuretools](https://github.com/Featuretools/featuretools) ⭐ 7,683 | 🐛 171 | 🌐 Python | 📅 2026-09-11 - Automated feature engineering.
...
* [tubular](https://github.com/azukds/tubular) ⭐ 108 | 🐛 71 | 🌐 Python | 📅 2026-08-19 - Collection of scikit-learn compatible transformers written in [narwhals](https://github.com/narwhals-dev/narwhals) ⭐ 1,722 | 🐛 258 | 🌐 Python | 📅 2026-09-21, which can accept either polars/pandas inputs and utilise the chosen library under the hood. <img height="20" src="img/sklearn_big.png" alt="sklearn"><img height="20" src="img/pandas_big.png" alt="pandas compatible">
...
* [Matplotlib](https://github.com/matplotlib/matplotlib) ⭐ 23,246 | 🐛 1,489 | 🌐 Python | 📅 2026-09-21 - Plotting with Python.
* [seaborn](https://github.com/mwaskom/seaborn) ⭐ 14,033 | 🐛 236 | 🌐 Python | 📅 2026-07-06 - Statistical data visualization using matplotlib.
...
* [Bokeh](https://github.com/bokeh/bokeh) ⭐ 20,456 | 🐛 846 | 🌐 Python | 📅 2026-09-21 - Interactive Web Plotting for Python.
* [pyecharts](https://github.com/pyecharts/pyecharts) ⭐ 15,771 | 🐛 4 | 🌐 Python | 📅 2026-08-04 - Migrated from [Echarts](https://github.com/apache/echarts) ⭐ 67,366 | 🐛 1,494 | 🌐 TypeScript | 📅 2026-09-16, a charting and visualization library, to Python's interactive visual drawing library.<img height="20" src="img/pyecharts.png" alt="pyecharts"> <img height="20" src="img/echarts.png" alt="echarts">
...
* [HoloViews](https://github.com/ioam/holoviews) ⭐ 2,910 | 🐛 1,024 | 🌐 Python | 📅 2026-09-21 - Stop plotting your data - annotate your data and let it visualize itself.
...
* [gradio](https://github.com/gradio-app/gradio) ⭐ 43,594 | 🐛 108 | 🌐 Python | 📅 2026-09-21 - Create UIs for your machine learning model in Python in 3 minutes.
...
* [Pandas Profiling](https://github.com/pandas-profiling/pandas-profiling) ⭐ 13,704 | 🐛 329 | 🌐 Python | 📅 2026-09-11 - Create HTML profiling reports from pandas DataFrame objects. <img height="20" src="img/pandas_big.png" alt="pandas compatible">
* [statsmodels](https://github.com/statsmodels/statsmodels) ⭐ 11,638 | 🐛 2,821 | 🌐 Python | 📅 2026-09-21 - Statistical modeling and econometrics in Python.
...
* [polars](https://github.com/pola-rs/polars) ⭐ 39,829 | 🐛 2,902 | 🌐 Rust | 📅 2026-09-21 - A fast multi-threaded, hybrid-out-of-core DataFrame library.
* [pandas\_profiling](https://github.com/pandas-profiling/pandas-profiling) ⭐ 13,704 | 🐛 329 | 🌐 Python | 📅 2026-09-11 - Create HTML profiling reports from pandas DataFrame objects
* [modin](https://github.com/modin-project/modin) ⭐ 10,389 | 🐛 716 | 🌐 Python | 📅 2026-02-10 - Speed up your pandas workflows by changing a single line of code. <img height="20" src="img/pandas_big.png" alt="pandas compatible">
* [cuDF](https://github.com/rapidsai/cudf) ⭐ 9,759 | 🐛 1,345 | 🌐 C++ | 📅 2026-09-21 - GPU DataFrame Library. <img height="20" src="img/pandas_big.png" alt="pandas compatible"> <img height="20" src="img/gpu_big.png" alt="GPU accelerated">
...
* [xarray](https://github.com/pydata/xarray) ⭐ 4,199 | 🐛 1,455 | 🌐 Python | 📅 2026-09-16 - Xarray combines the best features of NumPy and pandas for multidimensional data selection by supplementing numerical axis labels with named dimensions for more intuitive, concise, and less error-prone indexing routines.
...
* [Hamilton](https://github.com/DAGWorks-Inc/hamilton) ⭐ 2,595 | 🐛 178 | 🌐 Jupyter Notebook | 📅 2026-09-20 - A microframework for dataframe generation that applies Directed Acyclic Graphs specified by a flow of lazily evaluated Python functions.
* [pyjanitor](https://github.com/ericmjl/pyjanitor) ⭐ 1,500 | 🐛 148 | 🌐 Python | 📅 2026-09-21 - Clean APIs for data cleaning. <img height="20" src="img/pandas_big.png" alt="pandas compatible">
...
* [cleanlab](https://github.com/cleanlab/cleanlab) ⭐ 11,669 | 🐛 123 | 🌐 Python | 📅 2026-01-13 - The standard data-centric AI package for data quality and machine learning with messy, real-world data and labels.
...
* [PaddlePaddle](https://github.com/PaddlePaddle/Paddle) ⭐ 24,102 | 🐛 1,488 | 🌐 C++ | 📅 2026-09-21 - PArallel Distributed Deep LEarning.
...
* [Distributed](https://github.com/dask/distributed) ⭐ 1,693 | 🐛 1,520 | 🌐 Python | 📅 2026-09-21 - Distributed computation in Python.
...
* [mlflow](https://github.com/mlflow/mlflow) ⭐ 28,081 | 🐛 2,131 | 🌐 Python | 📅 2026-09-21 - Open source platform for the machine learning lifecycle.
* [dvc](https://github.com/iterative/dvc) ⭐ 15,880 | 🐛 213 | 🌐 Python | 📅 2026-09-21 - Data Version Control | Git for Data & Models | ML Experiments Management.
...
* [Ax](https://github.com/facebook/Ax) ⭐ 2,807 | 🐛 185 | 🌐 Python | 📅 2026-09-21 - Adaptive Experimentation Platform. <img height="20" src="img/sklearn_big.png" alt="sklearn">
* [envd](https://github.com/tensorchord/envd) ⭐ 2,233 | 🐛 139 | 🌐 Go | 📅 2026-07-25 - 🏕️ machine learning development environment for data science and AI/ML engineering teams.
* [Neptune](https://neptune.ai) - A lightweight ML experiment tracking, results visualization, and management tool.

## Data Validation

* [great\_expectations](https://github.com/great-expectations/great_expectations) ⭐ 11,823 | 🐛 66 | 🌐 Python | 📅 2026-09-18 - Always know what to expect from your data.
...
* [pandera](https://github.com/unionai-oss/pandera) ⭐ 4,460 | 🐛 447 | 🌐 Python | 📅 2026-09-19 - A lightweight, flexible, and expressive statistical data testing library.
* [deepchecks](https://github.com/deepchecks/deepchecks) ⭐ 4,056 | 🐛 267 | 🌐 Python | 📅 2025-12-28 - Validation & testing of ML models and data during model development, deployment, and production. <img height="20" src="img/sklearn_big.png" alt="sklearn">
...
* [DataComPy](https://github.com/capitalone/datacompy) ⭐ 658 | 🐛 7 | 🌐 Python | 📅 2026-09-21- A library to compare Pandas, Polars, and Spark data frames. It provides stats and lets users adjust for match accuracy.
...
* [Dask](https://github.com/dask/dask) ⭐ 13,922 | 🐛 1,337 | 🌐 Python | 📅 2026-08-24 - Parallel computing with task scheduling. <img height="20" src="img/pandas_big.png" alt="pandas compatible">
* [CuPy](https://github.com/cupy/cupy) ⭐ 12,336 | 🐛 685 | 🌐 Python | 📅 2026-09-21 - NumPy-like API accelerated with CUDA.
...
* [GeoPandas](https://github.com/geopandas/geopandas) ⭐ 5,256 | 🐛 417 | 🌐 Python | 📅 2026-09-20 - Python tools for geographic data. <img height="20" src="img/pandas_big.png" alt="pandas compatible">
* [PySal](https://github.com/pysal/pysal) ⭐ 1,524 | 🐛 24 | 🌐 Python | 📅 2026-08-03 - Python Spatial Analysis Library.

## Quantum Computing

* [qiskit](https://github.com/Qiskit/qiskit) ⭐ 7,820 | 🐛 1,038 | 🌐 Python | 📅 2026-09-21 - Qiskit is an open-source SDK for working with quantum computers at the level of circuits, algorithms, and application modules.
* [cirq](https://github.com/quantumlib/Cirq) ⭐ 5,065 | 🐛 126 | 🌐 Python | 📅 2026-09-18 - A python framework for creating, editing, and invoking Noisy Intermediate Scale Quantum (NISQ) circuits.
* [PennyLane](https://github.com/XanaduAI/pennylane) ⭐ 3,475 | 🐛 438 | 🌐 Python | 📅 2026-09-21 - Quantum machine learning, automatic differentiation, and optimization of hybrid quantum-classical computations.
* [QML](https://github.com/qmlcode/qml) ⚠️ Archived - A Python Toolkit for Quantum Machine Learning.

## Conversion

* [ONNX](https://github.com/onnx/onnx) ⭐ 21,514 | 🐛 239 | 🌐 Python | 📅 2026-09-21 - Open Neural Network Exchange.
...
Read the \<a href=[https://github.com/krzjoa/awesome-python-datascience/blob/master/CONTRIBUTING.md>contribution](https://github.com/krzjoa/awesome-python-datascience/blob/master/CONTRIBUTING.md>contribution) ⭐ 3,596 | 🐛 21 | 📅 2026-04-13 guideline</a>.
