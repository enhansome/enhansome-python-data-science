...
* [dlib](https://github.com/davisking/dlib) ⭐ 14,446 | 🐛 39 | 🌐 C++ | 📅 2026-09-23 - Toolkit for making real-world machine learning and data analysis applications in C++ (Python bindings).
* [PyCaret](https://github.com/pycaret/pycaret) ⭐ 9,845 | 🐛 34 | 🌐 Python | 📅 2026-07-23 - An open-source, low-code machine learning library in Python.  <img height="20" src="img/R_big.png" alt="R inspired lib">
* [causalml](https://github.com/uber/causalml) ⭐ 6,008 | 🐛 21 | 🌐 Python | 📅 2026-08-20 - Uplift modeling and causal inference with machine learning algorithms. <img height="20" src="img/sklearn_big.png" alt="sklearn">
* [mlpack](https://github.com/mlpack/mlpack) ⭐ 5,710 | 🐛 14 | 🌐 C++ | 📅 2026-09-17 - A scalable C++ machine learning library (Python bindings).
* [cuML](https://github.com/rapidsai/cuml) ⭐ 5,290 | 🐛 805 | 🌐 Python | 📅 2026-09-24 - RAPIDS Machine Learning Library. <img height="20" src="img/sklearn_big.png" alt="sklearn"> <img height="20" src="img/gpu_big.png" alt="GPU accelerated">
* [MLxtend](https://github.com/rasbt/mlxtend) ⭐ 5,176 | 🐛 142 | 🌐 Python | 📅 2026-09-18 - Extension and helper modules for Python's data analysis and machine learning libraries. <img height="20" src="img/sklearn_big.png" alt="sklearn">
...
* [pyGAM](https://github.com/dswah/pyGAM) ⭐ 1,017 | 🐛 237 | 🌐 Python | 📅 2026-04-21 - Generalized Additive Models in Python.
...
* [XGBoost](https://github.com/dmlc/xgboost) ⭐ 28,792 | 🐛 436 | 🌐 C++ | 📅 2026-09-24 - Scalable, Portable, and Distributed Gradient Boosting. <img height="20" src="img/sklearn_big.png" alt="sklearn"> <img height="20" src="img/gpu_big.png" alt="GPU accelerated">
* [LightGBM](https://github.com/Microsoft/LightGBM) ⭐ 18,811 | 🐛 521 | 🌐 C++ | 📅 2026-09-24 - A fast, distributed, high-performance gradient boosting. <img height="20" src="img/sklearn_big.png" alt="sklearn"> <img height="20" src="img/gpu_big.png" alt="GPU accelerated">
* [CatBoost](https://github.com/catboost/catboost) ⭐ 9,116 | 🐛 724 | 🌐 C++ | 📅 2026-09-24 - An open-source gradient boosting on decision trees library. <img height="20" src="img/sklearn_big.png" alt="sklearn"> <img height="20" src="img/gpu_big.png" alt="GPU accelerated">
...
* [PyTorch](https://github.com/pytorch/pytorch) ⭐ 103,261 | 🐛 17,602 | 🌐 Python | 📅 2026-09-24 - Tensors and Dynamic neural networks in Python with strong GPU acceleration. <img height="20" src="img/pytorch_big2.png" alt="PyTorch based/compatible">
* [pytorch-lightning](https://github.com/Lightning-AI/lightning) ⭐ 31,360 | 🐛 1,088 | 🌐 Python | 📅 2026-09-21 - PyTorch Lightning is just organized PyTorch. <img height="20" src="img/pytorch_big2.png" alt="PyTorch based/compatible">
...
* [ignite](https://github.com/pytorch/ignite) ⭐ 4,787 | 🐛 186 | 🌐 Python | 📅 2026-09-09 - High-level library to help with training neural networks in PyTorch. <img height="20" src="img/pytorch_big2.png" alt="PyTorch based/compatible">
...
* [TensorFlow](https://github.com/tensorflow/tensorflow) ⭐ 200,289 | 🐛 3,334 | 🌐 C++ | 📅 2026-09-24 - Computation using data flow graphs for scalable machine learning by Google. <img height="20" src="img/tf_big2.png" alt="sklearn">
* [Ludwig](https://github.com/uber/ludwig) ⭐ 11,763 | 🐛 1 | 🌐 Python | 📅 2026-09-21 - A toolbox that allows one to train and test deep learning models without the need to write code. <img height="20" src="img/tf_big2.png" alt="sklearn">
* [Sonnet](https://github.com/deepmind/sonnet) ⭐ 9,969 | 🐛 44 | 🌐 Python | 📅 2026-07-07 - TensorFlow-based neural network library. <img height="20" src="img/tf_big2.png" alt="sklearn">
...
* [TensorLayer](https://github.com/zsdonghao/tensorlayer) ⭐ 7,381 | 🐛 37 | 🌐 Python | 📅 2023-02-18 - Deep Learning and Reinforcement Learning Library for Researcher and Engineer. <img height="20" src="img/tf_big2.png" alt="sklearn">
...
* [tensorflow-upstream](https://github.com/ROCmSoftwarePlatform/tensorflow-upstream) ⭐ 706 | 🐛 95 | 🌐 C++ | 📅 2026-09-24 - TensorFlow ROCm port. <img height="20" src="img/tf_big2.png" alt="sklearn"> <img height="20" src="img/amd_big.png" alt="Possible to run on AMD GPU">
...
* [JAX](https://github.com/google/jax) ⭐ 36,333 | 🐛 2,586 | 🌐 Python | 📅 2026-09-24 - Composable transformations of Python+NumPy programs: differentiate, vectorize, JIT to GPU/TPU, and more.
* [FLAX](https://github.com/google/flax) ⭐ 7,333 | 🐛 522 | 🌐 Jupyter Notebook | 📅 2026-09-24 - A neural network library for JAX that is designed for flexibility.
* [Optax](https://github.com/google-deepmind/optax) ⭐ 2,342 | 🐛 129 | 🌐 Python | 📅 2026-09-24 - A gradient processing and optimization library for JAX.
...
* [transformers](https://github.com/huggingface/transformers) ⭐ 166,615 | 🐛 2,388 | 🌐 Python | 📅 2026-09-24 - State-of-the-art Machine Learning for Pytorch, TensorFlow, and JAX. <img height="20" src="img/pytorch_big2.png" alt="PyTorch based/compatible"> <img height="20" src="img/tf_big2.png" alt="sklearn">
* [Caffe](https://github.com/BVLC/caffe) ⭐ 34,551 | 🐛 1,175 | 🌐 C++ | 📅 2024-07-31 - A fast open framework for deep learning.
* [autograd](https://github.com/HIPS/autograd) ⭐ 7,533 | 🐛 188 | 🌐 Python | 📅 2026-09-21 - Efficiently computes derivatives of numpy code.
...
* [AutoGluon](https://github.com/awslabs/autogluon) ⭐ 10,746 | 🐛 376 | 🌐 Python | 📅 2026-09-24 - AutoML for Image, Text, Tabular, Time-Series, and MultiModal Data.
...
* [NLTK](https://github.com/nltk/nltk) ⭐ 14,725 | 🐛 258 | 🌐 Python | 📅 2026-09-24 -  Modules, data sets, and tutorials supporting research and development in Natural Language Processing.
...
* [KerasNLP](https://github.com/keras-team/keras-nlp) ⭐ 990 | 🐛 256 | 🌐 Python | 📅 2026-09-24 - Modular Natural Language Processing workflows with Keras. <img height="20" src="img/keras_big.png" alt="Keras based/compatible">
...
* [librosa](https://github.com/librosa/librosa) ⭐ 8,625 | 🐛 51 | 🌐 Python | 📅 2026-09-24 - Python library for audio and music analysis.
* [aubio](https://github.com/aubio/aubio) ⭐ 3,757 | 🐛 160 | 🌐 C | 📅 2026-04-10 - A library for audio and music analysis.
* [Essentia](https://github.com/MTG/essentia) ⭐ 3,741 | 🐛 440 | 🌐 C++ | 📅 2026-09-21 - Library for audio and music analysis, description, and synthesis.
* [torchaudio](https://github.com/pytorch/audio) ⭐ 2,945 | 🐛 340 | 🌐 Python | 📅 2026-09-24 - An audio library for PyTorch. <img height="20" src="img/pytorch_big2.png" alt="PyTorch based/compatible">
...
* [OpenCV](https://github.com/opencv/opencv) ⭐ 90,959 | 🐛 2,769 | 🌐 C++ | 📅 2026-09-24 - Open Source Computer Vision Library.
* [torchvision](https://github.com/pytorch/vision) ⭐ 17,926 | 🐛 1,225 | 🌐 Python | 📅 2026-09-24 - Datasets, Transforms, and Models specific to Computer Vision. <img height="20" src="img/pytorch_big2.png" alt="PyTorch based/compatible">
...
* [scikit-image](https://github.com/scikit-image/scikit-image) ⭐ 6,595 | 🐛 951 | 🌐 Python | 📅 2026-09-24 - Image Processing SciKit (Toolbox for SciPy).
...
* [Prophet](https://github.com/facebook/prophet) ⭐ 20,416 | 🐛 455 | 🌐 Python | 📅 2026-08-27 - Automatic Forecasting Procedure.
* [sktime](https://github.com/alan-turing-institute/sktime) ⭐ 10,043 | 🐛 2,522 | 🌐 Python | 📅 2026-09-24 - A unified framework for machine learning with time series. <img height="20" src="img/sklearn_big.png" alt="sklearn">
* [darts](https://github.com/unit8co/darts) ⭐ 9,526 | 🐛 222 | 🌐 Python | 📅 2026-09-24 - A python library for easy manipulation and forecasting of time series.
* [statsforecast](https://github.com/Nixtla/statsforecast) ⭐ 4,915 | 🐛 152 | 🌐 Python | 📅 2026-09-21 - Lightning fast forecasting with statistical and econometric models.
...
* [skforecast](https://github.com/JoaquinAmatRodrigo/skforecast) ⭐ 1,536 | 🐛 14 | 🌐 Python | 📅 2026-09-24 - Time series forecasting with machine learning models
* [mlforecast](https://github.com/Nixtla/mlforecast) ⭐ 1,282 | 🐛 21 | 🌐 Python | 📅 2026-09-23 - Scalable machine learning-based time series forecasting.
...
* [Gymnasium](https://github.com/Farama-Foundation/Gymnasium) ⭐ 12,578 | 🐛 91 | 🌐 Python | 📅 2026-09-21 - An API standard for single-agent reinforcement learning environments, with popular reference environments and related utilities (formerly [Gym](https://github.com/openai/gym) ⚠️ Archived).
...
* [cleanrl](https://github.com/vwxyzjn/cleanrl) ⭐ 10,452 | 🐛 113 | 🌐 Python | 📅 2026-04-20 - High-quality single file implementation of Deep Reinforcement Learning algorithms with research-friendly features (PPO, DQN, C51, DDPG, TD3, SAC, PPG).
...
* [Imitation](https://github.com/HumanCompatibleAI/imitation) ⭐ 1,801 | 🐛 99 | 🌐 Python | 📅 2025-01-07 - Clean PyTorch implementations of imitation and reward learning algorithms. <img height="20" src="img/pytorch_big2.png" alt="PyTorch based/compatible">
...
* [pytorch\_geometric](https://github.com/rusty1s/pytorch_geometric) ⭐ 24,097 | 🐛 1,346 | 🌐 Python | 📅 2026-09-01 - Geometric Deep Learning Extension Library for PyTorch. <img height="20" src="img/pytorch_big2.png" alt="PyTorch based/compatible">
* [TRL](https://github.com/huggingface/trl) ⭐ 19,382 | 🐛 285 | 🌐 Python | 📅 2026-09-24 - Train transformer language models with reinforcement learning.
...
* [Networkx](https://github.com/networkx/networkx) ⭐ 17,281 | 🐛 308 | 🌐 Python | 📅 2026-09-24 - Network Analysis in Python.
* [Rustworkx](https://github.com/Qiskit/rustworkx) ⭐ 1,760 | 🐛 138 | 🌐 Rust | 📅 2026-09-24 - A high performance Python graph library implemented in Rust.
...
* [pgmpy](https://github.com/pgmpy/pgmpy) ⭐ 3,338 | 🐛 637 | 🌐 Python | 📅 2026-09-24 - A python library for working with Probabilistic Graphical Models.
* [pyAgrum](https://agrum.gitlab.io/) - A GRaphical Universal Modeler.

## Probabilistic Methods

* [PyMC](https://github.com/pymc-devs/pymc) ⭐ 9,771 | 🐛 512 | 🌐 Python | 📅 2026-09-21 - Bayesian Stochastic Modelling in Python.
...
* [GPyTorch](https://github.com/cornellius-gp/gpytorch) ⭐ 3,917 | 🐛 425 | 🌐 Python | 📅 2026-07-10 - A highly efficient and modular implementation of Gaussian Processes in PyTorch. <img height="20" src="img/pytorch_big2.png" alt="PyTorch based/compatible">
...
* [skpro](https://github.com/alan-turing-institute/skpro) ⭐ 336 | 🐛 267 | 🌐 Python | 📅 2026-09-24 - Supervised domain-agnostic prediction framework for probabilistic modelling by [The Alan Turing Institute](https://www.turing.ac.uk/). <img height="20" src="img/sklearn_big.png" alt="sklearn">
...
* [Netron](https://github.com/lutzroeder/Netron) ⭐ 33,522 | 🐛 18 | 🌐 JavaScript | 📅 2026-09-24 - Visualizer for deep learning and machine learning models (no Python code, but visualizes models from most Python Deep Learning frameworks).
* [shap](https://github.com/slundberg/shap) ⭐ 25,783 | 🐛 983 | 🌐 Jupyter Notebook | 📅 2026-09-21 - A unified approach to explain the output of any machine learning model. <img height="20" src="img/sklearn_big.png" alt="sklearn">
...
* [Optuna](https://github.com/optuna/optuna) ⭐ 14,845 | 🐛 22 | 🌐 Python | 📅 2026-09-24 - A hyperparameter optimization framework.
* [Bayesian Optimization](https://github.com/fmfn/BayesianOptimization) ⭐ 8,713 | 🐛 7 | 🌐 Python | 📅 2026-08-21 - A Python implementation of global optimization with gaussian processes.
...
* [scikit-opt](https://github.com/guofei9987/scikit-opt) ⭐ 6,718 | 🐛 71 | 🌐 Python | 📅 2026-03-25 - Heuristic Algorithms for optimization.
...
* [SMAC3](https://github.com/automl/SMAC3) ⭐ 1,250 | 🐛 112 | 🌐 Python | 📅 2026-09-24 - Sequential Model-based Algorithm Configuration.
...
* [tsfresh](https://github.com/blue-yonder/tsfresh) ⭐ 9,431 | 🐛 74 | 🌐 Jupyter Notebook | 📅 2026-07-06 - Automatic extraction of relevant features from time series. <img height="20" src="img/sklearn_big.png" alt="sklearn">
...
* [tubular](https://github.com/azukds/tubular) ⭐ 108 | 🐛 71 | 🌐 Python | 📅 2026-09-23 - Collection of scikit-learn compatible transformers written in [narwhals](https://github.com/narwhals-dev/narwhals) ⭐ 1,723 | 🐛 261 | 🌐 Python | 📅 2026-09-24, which can accept either polars/pandas inputs and utilise the chosen library under the hood. <img height="20" src="img/sklearn_big.png" alt="sklearn"><img height="20" src="img/pandas_big.png" alt="pandas compatible">
...
* [Matplotlib](https://github.com/matplotlib/matplotlib) ⭐ 23,261 | 🐛 1,487 | 🌐 Python | 📅 2026-09-24 - Plotting with Python.
* [seaborn](https://github.com/mwaskom/seaborn) ⭐ 14,041 | 🐛 236 | 🌐 Python | 📅 2026-07-06 - Statistical data visualization using matplotlib.
...
* [Bokeh](https://github.com/bokeh/bokeh) ⭐ 20,460 | 🐛 843 | 🌐 TypeScript | 📅 2026-09-24 - Interactive Web Plotting for Python.
* [pyecharts](https://github.com/pyecharts/pyecharts) ⭐ 15,771 | 🐛 4 | 🌐 Python | 📅 2026-08-04 - Migrated from [Echarts](https://github.com/apache/echarts) ⭐ 67,393 | 🐛 1,494 | 🌐 TypeScript | 📅 2026-09-16, a charting and visualization library, to Python's interactive visual drawing library.<img height="20" src="img/pyecharts.png" alt="pyecharts"> <img height="20" src="img/echarts.png" alt="echarts">
...
* [geemap](https://github.com/giswqs/geemap) ⭐ 4,033 | 🐛 50 | 🌐 Python | 📅 2026-09-24 - Python package for interactive mapping with Google Earth Engine (GEE)
...
* [gradio](https://github.com/gradio-app/gradio) ⭐ 43,619 | 🐛 91 | 🌐 Python | 📅 2026-09-24 - Create UIs for your machine learning model in Python in 3 minutes.
* [Vizro](https://github.com/mckinsey/vizro) ⭐ 3,797 | 🐛 39 | 🌐 Python | 📅 2026-09-24 - A toolkit for creating modular data visualization applications.
* [Deepnote](https://github.com/deepnote/deepnote) ⭐ 3,009 | 🐛 38 | 🌐 TypeScript | 📅 2026-09-24 - Deepnote is a drop-in replacement for Jupyter with an AI-first design, sleek UI, new blocks, and native data integrations. Use Python, R, and SQL locally in your favorite IDE, then scale to Deepnote cloud for real-time collaboration, Deepnote agent, and deployable data apps.
...
* [Pandas Profiling](https://github.com/pandas-profiling/pandas-profiling) ⭐ 13,712 | 🐛 329 | 🌐 Python | 📅 2026-09-11 - Create HTML profiling reports from pandas DataFrame objects. <img height="20" src="img/pandas_big.png" alt="pandas compatible">
* [statsmodels](https://github.com/statsmodels/statsmodels) ⭐ 11,651 | 🐛 2,826 | 🌐 Python | 📅 2026-09-24 - Statistical modeling and econometrics in Python.
* [Alphalens](https://github.com/quantopian/alphalens) ⭐ 4,455 | 🐛 50 | 🌐 Jupyter Notebook | 📅 2024-02-12 - Performance analysis of predictive (alpha) stock factors.
...
* [polars](https://github.com/pola-rs/polars) ⭐ 39,855 | 🐛 2,940 | 🌐 Rust | 📅 2026-09-24 - A fast multi-threaded, hybrid-out-of-core DataFrame library.
* [pandas\_profiling](https://github.com/pandas-profiling/pandas-profiling) ⭐ 13,712 | 🐛 329 | 🌐 Python | 📅 2026-09-11 - Create HTML profiling reports from pandas DataFrame objects
...
* [cuDF](https://github.com/rapidsai/cudf) ⭐ 9,761 | 🐛 1,360 | 🌐 C++ | 📅 2026-09-24 - GPU DataFrame Library. <img height="20" src="img/pandas_big.png" alt="pandas compatible"> <img height="20" src="img/gpu_big.png" alt="GPU accelerated">
* [vaex](https://github.com/vaexio/vaex) ⭐ 8,509 | 🐛 554 | 🌐 Python | 📅 2026-04-01 - Out-of-Core DataFrames for Python, ML, visualize and explore big tabular data at a billion rows per second.
* [xarray](https://github.com/pydata/xarray) ⭐ 4,200 | 🐛 1,460 | 🌐 Python | 📅 2026-09-23 - Xarray combines the best features of NumPy and pandas for multidimensional data selection by supplementing numerical axis labels with named dimensions for more intuitive, concise, and less error-prone indexing routines.
...
* [Hamilton](https://github.com/DAGWorks-Inc/hamilton) ⭐ 2,599 | 🐛 177 | 🌐 Jupyter Notebook | 📅 2026-09-24 - A microframework for dataframe generation that applies Directed Acyclic Graphs specified by a flow of lazily evaluated Python functions.
* [pyjanitor](https://github.com/ericmjl/pyjanitor) ⭐ 1,500 | 🐛 148 | 🌐 Python | 📅 2026-09-24 - Clean APIs for data cleaning. <img height="20" src="img/pandas_big.png" alt="pandas compatible">
...
* [cleanlab](https://github.com/cleanlab/cleanlab) ⭐ 11,672 | 🐛 124 | 🌐 Python | 📅 2026-01-13 - The standard data-centric AI package for data quality and machine learning with messy, real-world data and labels.
...
* [PaddlePaddle](https://github.com/PaddlePaddle/Paddle) ⭐ 24,103 | 🐛 1,479 | 🌐 C++ | 📅 2026-09-24 - PArallel Distributed Deep LEarning.
...
* [Distributed](https://github.com/dask/distributed) ⭐ 1,693 | 🐛 1,520 | 🌐 Python | 📅 2026-09-24 - Distributed computation in Python.
...
* [mlflow](https://github.com/mlflow/mlflow) ⭐ 28,127 | 🐛 2,149 | 🌐 Python | 📅 2026-09-24 - Open source platform for the machine learning lifecycle.
...
* [Ax](https://github.com/facebook/Ax) ⭐ 2,811 | 🐛 185 | 🌐 Python | 📅 2026-09-21 - Adaptive Experimentation Platform. <img height="20" src="img/sklearn_big.png" alt="sklearn">
* [envd](https://github.com/tensorchord/envd) ⭐ 2,235 | 🐛 139 | 🌐 Go | 📅 2026-07-25 - 🏕️ machine learning development environment for data science and AI/ML engineering teams.
* [Neptune](https://neptune.ai) - A lightweight ML experiment tracking, results visualization, and management tool.

## Data Validation

* [great\_expectations](https://github.com/great-expectations/great_expectations) ⭐ 11,837 | 🐛 74 | 🌐 Python | 📅 2026-09-24 - Always know what to expect from your data.
* [evidently](https://github.com/evidentlyai/evidently) ⭐ 7,937 | 🐛 315 | 🌐 Jupyter Notebook | 📅 2026-09-11 - Evaluate and monitor ML models from validation to production.
* [pandera](https://github.com/unionai-oss/pandera) ⭐ 4,465 | 🐛 454 | 🌐 Python | 📅 2026-09-22 - A lightweight, flexible, and expressive statistical data testing library.
...
* [DataComPy](https://github.com/capitalone/datacompy) ⭐ 659 | 🐛 8 | 🌐 Python | 📅 2026-09-24- A library to compare Pandas, Polars, and Spark data frames. It provides stats and lets users adjust for match accuracy.

## Evaluation

* [AI Fairness 360](https://github.com/IBM/AIF360) ⭐ 2,867 | 🐛 225 | 🌐 Python | 📅 2026-06-15 - Fairness metrics for datasets and ML models, explanations, and algorithms to mitigate bias in datasets and models.
...
* [Dask](https://github.com/dask/dask) ⭐ 13,924 | 🐛 1,342 | 🌐 Python | 📅 2026-08-24 - Parallel computing with task scheduling. <img height="20" src="img/pandas_big.png" alt="pandas compatible">
* [CuPy](https://github.com/cupy/cupy) ⭐ 12,343 | 🐛 686 | 🌐 Python | 📅 2026-09-23 - NumPy-like API accelerated with CUDA.
...
* [GeoPandas](https://github.com/geopandas/geopandas) ⭐ 5,260 | 🐛 419 | 🌐 Python | 📅 2026-09-24 - Python tools for geographic data. <img height="20" src="img/pandas_big.png" alt="pandas compatible">
* [PySal](https://github.com/pysal/pysal) ⭐ 1,526 | 🐛 24 | 🌐 Python | 📅 2026-08-03 - Python Spatial Analysis Library.

## Quantum Computing

* [qiskit](https://github.com/Qiskit/qiskit) ⭐ 7,830 | 🐛 1,021 | 🌐 Python | 📅 2026-09-24 - Qiskit is an open-source SDK for working with quantum computers at the level of circuits, algorithms, and application modules.
* [cirq](https://github.com/quantumlib/Cirq) ⭐ 5,070 | 🐛 125 | 🌐 Python | 📅 2026-09-24 - A python framework for creating, editing, and invoking Noisy Intermediate Scale Quantum (NISQ) circuits.
* [PennyLane](https://github.com/XanaduAI/pennylane) ⭐ 3,476 | 🐛 444 | 🌐 Python | 📅 2026-09-24 - Quantum machine learning, automatic differentiation, and optimization of hybrid quantum-classical computations.
* [QML](https://github.com/qmlcode/qml) ⚠️ Archived - A Python Toolkit for Quantum Machine Learning.

## Conversion

* [ONNX](https://github.com/onnx/onnx) ⭐ 21,521 | 🐛 241 | 🌐 Python | 📅 2026-09-24 - Open Neural Network Exchange.
