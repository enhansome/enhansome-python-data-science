...
* [causalml](https://github.com/uber/causalml) ⭐ 6,006 | 🐛 21 | 🌐 Python | 📅 2026-08-20 - Uplift modeling and causal inference with machine learning algorithms. <img height="20" src="img/sklearn_big.png" alt="sklearn">
* [mlpack](https://github.com/mlpack/mlpack) ⭐ 5,710 | 🐛 12 | 🌐 C++ | 📅 2026-09-17 - A scalable C++ machine learning library (Python bindings).
* [cuML](https://github.com/rapidsai/cuml) ⭐ 5,287 | 🐛 798 | 🌐 Python | 📅 2026-09-22 - RAPIDS Machine Learning Library. <img height="20" src="img/sklearn_big.png" alt="sklearn"> <img height="20" src="img/gpu_big.png" alt="GPU accelerated">
...
* [XGBoost](https://github.com/dmlc/xgboost) ⭐ 28,786 | 🐛 434 | 🌐 C++ | 📅 2026-09-22 - Scalable, Portable, and Distributed Gradient Boosting. <img height="20" src="img/sklearn_big.png" alt="sklearn"> <img height="20" src="img/gpu_big.png" alt="GPU accelerated">
* [LightGBM](https://github.com/Microsoft/LightGBM) ⭐ 18,797 | 🐛 525 | 🌐 C++ | 📅 2026-09-21 - A fast, distributed, high-performance gradient boosting. <img height="20" src="img/sklearn_big.png" alt="sklearn"> <img height="20" src="img/gpu_big.png" alt="GPU accelerated">
* [CatBoost](https://github.com/catboost/catboost) ⭐ 9,113 | 🐛 724 | 🌐 C++ | 📅 2026-09-22 - An open-source gradient boosting on decision trees library. <img height="20" src="img/sklearn_big.png" alt="sklearn"> <img height="20" src="img/gpu_big.png" alt="GPU accelerated">
...
* [imbalanced-learn](https://github.com/scikit-learn-contrib/imbalanced-learn) ⭐ 7,122 | 🐛 94 | 🌐 Python | 📅 2026-06-29 - Module to perform under-sampling and over-sampling with various techniques. <img height="20" src="img/sklearn_big.png" alt="sklearn">
...
* [PyTorch](https://github.com/pytorch/pytorch) ⭐ 103,179 | 🐛 17,602 | 🌐 Python | 📅 2026-09-22 - Tensors and Dynamic neural networks in Python with strong GPU acceleration. <img height="20" src="img/pytorch_big2.png" alt="PyTorch based/compatible">
* [pytorch-lightning](https://github.com/Lightning-AI/lightning) ⭐ 31,357 | 🐛 1,084 | 🌐 Python | 📅 2026-09-21 - PyTorch Lightning is just organized PyTorch. <img height="20" src="img/pytorch_big2.png" alt="PyTorch based/compatible">
* [skorch](https://github.com/dnouri/skorch) ⭐ 6,179 | 🐛 65 | 🌐 Jupyter Notebook | 📅 2026-09-22 - A scikit-learn compatible neural network library that wraps PyTorch. <img height="20" src="img/sklearn_big.png" alt="sklearn"> <img height="20" src="img/pytorch_big2.png" alt="PyTorch based/compatible">
...
* [TensorFlow](https://github.com/tensorflow/tensorflow) ⭐ 200,254 | 🐛 3,311 | 🌐 C++ | 📅 2026-09-22 - Computation using data flow graphs for scalable machine learning by Google. <img height="20" src="img/tf_big2.png" alt="sklearn">
* [Ludwig](https://github.com/uber/ludwig) ⭐ 11,765 | 🐛 1 | 🌐 Python | 📅 2026-09-21 - A toolbox that allows one to train and test deep learning models without the need to write code. <img height="20" src="img/tf_big2.png" alt="sklearn">
...
* [TFLearn](https://github.com/tflearn/tflearn) ⭐ 9,573 | 🐛 579 | 🌐 Python | 📅 2024-05-06 - Deep learning library featuring a higher-level API for TensorFlow. <img height="20" src="img/tf_big2.png" alt="sklearn">
...
* [tensorflow-upstream](https://github.com/ROCmSoftwarePlatform/tensorflow-upstream) ⭐ 706 | 🐛 96 | 🌐 C++ | 📅 2026-09-22 - TensorFlow ROCm port. <img height="20" src="img/tf_big2.png" alt="sklearn"> <img height="20" src="img/amd_big.png" alt="Possible to run on AMD GPU">
...
* [JAX](https://github.com/google/jax) ⭐ 36,326 | 🐛 2,598 | 🌐 Python | 📅 2026-09-22 - Composable transformations of Python+NumPy programs: differentiate, vectorize, JIT to GPU/TPU, and more.
* [FLAX](https://github.com/google/flax) ⭐ 7,329 | 🐛 522 | 🌐 Jupyter Notebook | 📅 2026-09-16 - A neural network library for JAX that is designed for flexibility.
* [Optax](https://github.com/google-deepmind/optax) ⭐ 2,340 | 🐛 127 | 🌐 Python | 📅 2026-09-14 - A gradient processing and optimization library for JAX.
...
* [transformers](https://github.com/huggingface/transformers) ⭐ 166,534 | 🐛 2,394 | 🌐 Python | 📅 2026-09-22 - State-of-the-art Machine Learning for Pytorch, TensorFlow, and JAX. <img height="20" src="img/pytorch_big2.png" alt="PyTorch based/compatible"> <img height="20" src="img/tf_big2.png" alt="sklearn">
* [Caffe](https://github.com/BVLC/caffe) ⭐ 34,551 | 🐛 1,175 | 🌐 C++ | 📅 2024-07-31 - A fast open framework for deep learning.
* [autograd](https://github.com/HIPS/autograd) ⭐ 7,532 | 🐛 187 | 🌐 Python | 📅 2026-09-21 - Efficiently computes derivatives of numpy code.
...
* [AutoGluon](https://github.com/awslabs/autogluon) ⭐ 10,734 | 🐛 383 | 🌐 Python | 📅 2026-09-22 - AutoML for Image, Text, Tabular, Time-Series, and MultiModal Data.
...
* [NLTK](https://github.com/nltk/nltk) ⭐ 14,723 | 🐛 260 | 🌐 Python | 📅 2026-09-21 -  Modules, data sets, and tutorials supporting research and development in Natural Language Processing.
...
* [KerasNLP](https://github.com/keras-team/keras-nlp) ⭐ 990 | 🐛 256 | 🌐 Python | 📅 2026-09-22 - Modular Natural Language Processing workflows with Keras. <img height="20" src="img/keras_big.png" alt="Keras based/compatible">
...
* [librosa](https://github.com/librosa/librosa) ⭐ 8,622 | 🐛 51 | 🌐 Python | 📅 2026-09-21 - Python library for audio and music analysis.
* [aubio](https://github.com/aubio/aubio) ⭐ 3,757 | 🐛 160 | 🌐 C | 📅 2026-04-10 - A library for audio and music analysis.
* [Essentia](https://github.com/MTG/essentia) ⭐ 3,735 | 🐛 439 | 🌐 C++ | 📅 2026-09-21 - Library for audio and music analysis, description, and synthesis.
* [torchaudio](https://github.com/pytorch/audio) ⭐ 2,943 | 🐛 340 | 🌐 Python | 📅 2026-09-22 - An audio library for PyTorch. <img height="20" src="img/pytorch_big2.png" alt="PyTorch based/compatible">
* [madmom](https://github.com/CPJKU/madmom) ⭐ 1,713 | 🐛 81 | 🌐 Python | 📅 2026-03-20 - Python audio and music signal processing library.
...
* [OpenCV](https://github.com/opencv/opencv) ⭐ 90,931 | 🐛 2,772 | 🌐 C++ | 📅 2026-09-22 - Open Source Computer Vision Library.
* [torchvision](https://github.com/pytorch/vision) ⭐ 17,927 | 🐛 1,223 | 🌐 Python | 📅 2026-09-22 - Datasets, Transforms, and Models specific to Computer Vision. <img height="20" src="img/pytorch_big2.png" alt="PyTorch based/compatible">
...
* [scikit-image](https://github.com/scikit-image/scikit-image) ⭐ 6,595 | 🐛 953 | 🌐 Python | 📅 2026-09-22 - Image Processing SciKit (Toolbox for SciPy).
...
* [Prophet](https://github.com/facebook/prophet) ⭐ 20,411 | 🐛 455 | 🌐 Python | 📅 2026-08-27 - Automatic Forecasting Procedure.
* [sktime](https://github.com/alan-turing-institute/sktime) ⭐ 10,030 | 🐛 2,497 | 🌐 Python | 📅 2026-09-22 - A unified framework for machine learning with time series. <img height="20" src="img/sklearn_big.png" alt="sklearn">
* [darts](https://github.com/unit8co/darts) ⭐ 9,522 | 🐛 221 | 🌐 Python | 📅 2026-09-18 - A python library for easy manipulation and forecasting of time series.
* [statsforecast](https://github.com/Nixtla/statsforecast) ⭐ 4,913 | 🐛 150 | 🌐 Python | 📅 2026-09-21 - Lightning fast forecasting with statistical and econometric models.
* [neuralforecast](https://github.com/Nixtla/neuralforecast) ⭐ 4,276 | 🐛 14 | 🌐 Python | 📅 2026-09-21 - Scalable machine learning-based time series forecasting.
...
* [tslearn](https://github.com/rtavenar/tslearn) ⭐ 3,180 | 🐛 80 | 🌐 Python | 📅 2026-09-22 - Machine learning toolkit dedicated to time-series data. <img height="20" src="img/sklearn_big.png" alt="sklearn">
...
* [skforecast](https://github.com/JoaquinAmatRodrigo/skforecast) ⭐ 1,536 | 🐛 13 | 🌐 Python | 📅 2026-09-21 - Time series forecasting with machine learning models
* [mlforecast](https://github.com/Nixtla/mlforecast) ⭐ 1,280 | 🐛 18 | 🌐 Python | 📅 2026-09-21 - Scalable machine learning-based time series forecasting.
...
* [Stable Baselines3](https://github.com/DLR-RM/stable-baselines3) ⭐ 13,837 | 🐛 89 | 🌐 Python | 📅 2026-09-09 - A set of improved implementations of reinforcement learning algorithms based on OpenAI Baselines.
* [Gymnasium](https://github.com/Farama-Foundation/Gymnasium) ⭐ 12,567 | 🐛 91 | 🌐 Python | 📅 2026-09-21 - An API standard for single-agent reinforcement learning environments, with popular reference environments and related utilities (formerly [Gym](https://github.com/openai/gym) ⚠️ Archived).
* [Tianshou](https://github.com/thu-ml/tianshou/#comprehensive-functionality) ⭐ 10,990 | 🐛 142 | 🌐 Python | 📅 2026-04-03 - An elegant PyTorch deep reinforcement learning library. <img height="20" src="img/pytorch_big2.png" alt="PyTorch based/compatible">
...
* [cleanrl](https://github.com/vwxyzjn/cleanrl) ⭐ 10,442 | 🐛 113 | 🌐 Python | 📅 2026-04-20 - High-quality single file implementation of Deep Reinforcement Learning algorithms with research-friendly features (PPO, DQN, C51, DDPG, TD3, SAC, PPG).
...
* [Acme](https://github.com/google-deepmind/acme) ⭐ 4,066 | 🐛 102 | 🌐 Python | 📅 2026-09-16 - A library of reinforcement learning components and agents.
...
* [MAgent2](https://github.com/Farama-Foundation/MAgent2) ⭐ 966 | 🐛 18 | 🌐 Python | 📅 2026-09-13 - An engine for high performance multi-agent environments with very large numbers of agents, along with a set of reference environments.
...
* [pytorch\_geometric](https://github.com/rusty1s/pytorch_geometric) ⭐ 24,098 | 🐛 1,345 | 🌐 Python | 📅 2026-09-01 - Geometric Deep Learning Extension Library for PyTorch. <img height="20" src="img/pytorch_big2.png" alt="PyTorch based/compatible">
* [TRL](https://github.com/huggingface/trl) ⭐ 19,361 | 🐛 284 | 🌐 Python | 📅 2026-09-22 - Train transformer language models with reinforcement learning.
...
* [TensorFlow GNN](https://github.com/tensorflow/gnn) ⭐ 1,546 | 🐛 42 | 🌐 Python | 📅 2026-09-09 - A library to build Graph Neural Networks on the TensorFlow platform. <img height="20" src="img/tf_big2.png" alt="TensorFlow">
...
* [Networkx](https://github.com/networkx/networkx) ⭐ 17,275 | 🐛 317 | 🌐 Python | 📅 2026-09-21 - Network Analysis in Python.
...
* [TensorFlow Recommenders](https://github.com/tensorflow/recommenders) ⭐ 2,032 | 🐛 280 | 🌐 Python | 📅 2026-07-08 - A library for building recommender system models using TensorFlow. <img height="20" src="img/tf_big2.png" alt="TensorFlow"> <img height="20" src="img/keras_big.png" alt="Keras compatible">
...
* [pgmpy](https://github.com/pgmpy/pgmpy) ⭐ 3,334 | 🐛 640 | 🌐 Python | 📅 2026-09-22 - A python library for working with Probabilistic Graphical Models.
* [pyAgrum](https://agrum.gitlab.io/) - A GRaphical Universal Modeler.

## Probabilistic Methods

* [PyMC](https://github.com/pymc-devs/pymc) ⭐ 9,768 | 🐛 509 | 🌐 Python | 📅 2026-09-21 - Bayesian Stochastic Modelling in Python.
* [pyro](https://github.com/uber/pyro) ⭐ 9,058 | 🐛 293 | 🌐 Python | 📅 2026-09-07 - A flexible, scalable deep probabilistic programming library built on PyTorch. <img height="20" src="img/pytorch_big2.png" alt="PyTorch based/compatible">
* [GPyTorch](https://github.com/cornellius-gp/gpytorch) ⭐ 3,916 | 🐛 424 | 🌐 Python | 📅 2026-07-10 - A highly efficient and modular implementation of Gaussian Processes in PyTorch. <img height="20" src="img/pytorch_big2.png" alt="PyTorch based/compatible">
...
* [skpro](https://github.com/alan-turing-institute/skpro) ⭐ 336 | 🐛 265 | 🌐 Python | 📅 2026-09-21 - Supervised domain-agnostic prediction framework for probabilistic modelling by [The Alan Turing Institute](https://www.turing.ac.uk/). <img height="20" src="img/sklearn_big.png" alt="sklearn">
...
* [Netron](https://github.com/lutzroeder/Netron) ⭐ 33,508 | 🐛 18 | 🌐 JavaScript | 📅 2026-09-22 - Visualizer for deep learning and machine learning models (no Python code, but visualizes models from most Python Deep Learning frameworks).
* [shap](https://github.com/slundberg/shap) ⭐ 25,773 | 🐛 984 | 🌐 Jupyter Notebook | 📅 2026-09-21 - A unified approach to explain the output of any machine learning model. <img height="20" src="img/sklearn_big.png" alt="sklearn">
...
* [aequitas](https://github.com/dssg/aequitas) ⭐ 774 | 🐛 56 | 🌐 Python | 📅 2026-05-12 - Bias and Fairness Audit Toolkit.
...
* [Optuna](https://github.com/optuna/optuna) ⭐ 14,834 | 🐛 22 | 🌐 Python | 📅 2026-09-22 - A hyperparameter optimization framework.
* [Bayesian Optimization](https://github.com/fmfn/BayesianOptimization) ⭐ 8,714 | 🐛 7 | 🌐 Python | 📅 2026-08-21 - A Python implementation of global optimization with gaussian processes.
...
* [BoTorch](https://github.com/pytorch/botorch) ⭐ 3,601 | 🐛 95 | 🌐 Jupyter Notebook | 📅 2026-09-08 - Bayesian optimization in PyTorch. <img height="20" src="img/pytorch_big2.png" alt="PyTorch based/compatible">
* [pymoo](https://github.com/anyoptimization/pymoo) ⭐ 2,962 | 🐛 0 | 🌐 Python | 📅 2026-07-07 - Multi-objective Optimization in Python.
...
* [SMAC3](https://github.com/automl/SMAC3) ⭐ 1,249 | 🐛 112 | 🌐 Python | 📅 2026-09-22 - Sequential Model-based Algorithm Configuration.
...
* [tsfresh](https://github.com/blue-yonder/tsfresh) ⭐ 9,427 | 🐛 74 | 🌐 Jupyter Notebook | 📅 2026-07-06 - Automatic extraction of relevant features from time series. <img height="20" src="img/sklearn_big.png" alt="sklearn">
...
* [tubular](https://github.com/azukds/tubular) ⭐ 108 | 🐛 71 | 🌐 Python | 📅 2026-08-19 - Collection of scikit-learn compatible transformers written in [narwhals](https://github.com/narwhals-dev/narwhals) ⭐ 1,722 | 🐛 259 | 🌐 Python | 📅 2026-09-22, which can accept either polars/pandas inputs and utilise the chosen library under the hood. <img height="20" src="img/sklearn_big.png" alt="sklearn"><img height="20" src="img/pandas_big.png" alt="pandas compatible">
...
* [Matplotlib](https://github.com/matplotlib/matplotlib) ⭐ 23,251 | 🐛 1,485 | 🌐 Python | 📅 2026-09-22 - Plotting with Python.
...
* [chartify](https://github.com/spotify/chartify/) ⭐ 3,649 | 🐛 55 | 🌐 Python | 📅 2024-10-16 - Python library that makes it easy for data scientists to create charts.
...
* [Bokeh](https://github.com/bokeh/bokeh) ⭐ 20,456 | 🐛 845 | 🌐 Python | 📅 2026-09-22 - Interactive Web Plotting for Python.
* [pyecharts](https://github.com/pyecharts/pyecharts) ⭐ 15,772 | 🐛 4 | 🌐 Python | 📅 2026-08-04 - Migrated from [Echarts](https://github.com/apache/echarts) ⭐ 67,376 | 🐛 1,494 | 🌐 TypeScript | 📅 2026-09-16, a charting and visualization library, to Python's interactive visual drawing library.<img height="20" src="img/pyecharts.png" alt="pyecharts"> <img height="20" src="img/echarts.png" alt="echarts">
...
* [geemap](https://github.com/giswqs/geemap) ⭐ 4,030 | 🐛 58 | 🌐 Python | 📅 2026-09-22 - Python package for interactive mapping with Google Earth Engine (GEE)
...
* [HoloViews](https://github.com/ioam/holoviews) ⭐ 2,910 | 🐛 1,023 | 🌐 Python | 📅 2026-09-22 - Stop plotting your data - annotate your data and let it visualize itself.
...
* [gradio](https://github.com/gradio-app/gradio) ⭐ 43,600 | 🐛 98 | 🌐 Python | 📅 2026-09-22 - Create UIs for your machine learning model in Python in 3 minutes.
...
* [Deepnote](https://github.com/deepnote/deepnote) ⭐ 3,009 | 🐛 31 | 🌐 TypeScript | 📅 2026-09-22 - Deepnote is a drop-in replacement for Jupyter with an AI-first design, sleek UI, new blocks, and native data integrations. Use Python, R, and SQL locally in your favorite IDE, then scale to Deepnote cloud for real-time collaboration, Deepnote agent, and deployable data apps.
* [streamsync](https://github.com/streamsync-cloud/streamsync) ⭐ 1,449 | 🐛 13 | 🌐 Python | 📅 2026-09-22 - No-code in the front, Python in the back. An open-source framework for creating data apps.
...
* [Pandas Profiling](https://github.com/pandas-profiling/pandas-profiling) ⭐ 13,708 | 🐛 329 | 🌐 Python | 📅 2026-09-11 - Create HTML profiling reports from pandas DataFrame objects. <img height="20" src="img/pandas_big.png" alt="pandas compatible">
* [statsmodels](https://github.com/statsmodels/statsmodels) ⭐ 11,643 | 🐛 2,824 | 🌐 Python | 📅 2026-09-21 - Statistical modeling and econometrics in Python.
* [Alphalens](https://github.com/quantopian/alphalens) ⭐ 4,451 | 🐛 50 | 🌐 Jupyter Notebook | 📅 2024-02-12 - Performance analysis of predictive (alpha) stock factors.
...
* [polars](https://github.com/pola-rs/polars) ⭐ 39,841 | 🐛 2,908 | 🌐 Rust | 📅 2026-09-22 - A fast multi-threaded, hybrid-out-of-core DataFrame library.
* [pandas\_profiling](https://github.com/pandas-profiling/pandas-profiling) ⭐ 13,708 | 🐛 329 | 🌐 Python | 📅 2026-09-11 - Create HTML profiling reports from pandas DataFrame objects
...
* [cuDF](https://github.com/rapidsai/cudf) ⭐ 9,759 | 🐛 1,348 | 🌐 C++ | 📅 2026-09-22 - GPU DataFrame Library. <img height="20" src="img/pandas_big.png" alt="pandas compatible"> <img height="20" src="img/gpu_big.png" alt="GPU accelerated">
...
* [xarray](https://github.com/pydata/xarray) ⭐ 4,199 | 🐛 1,457 | 🌐 Python | 📅 2026-09-16 - Xarray combines the best features of NumPy and pandas for multidimensional data selection by supplementing numerical axis labels with named dimensions for more intuitive, concise, and less error-prone indexing routines.
...
* [Hamilton](https://github.com/DAGWorks-Inc/hamilton) ⭐ 2,597 | 🐛 177 | 🌐 Jupyter Notebook | 📅 2026-09-20 - A microframework for dataframe generation that applies Directed Acyclic Graphs specified by a flow of lazily evaluated Python functions.
* [pyjanitor](https://github.com/ericmjl/pyjanitor) ⭐ 1,500 | 🐛 148 | 🌐 Python | 📅 2026-09-22 - Clean APIs for data cleaning. <img height="20" src="img/pandas_big.png" alt="pandas compatible">
...
* [cleanlab](https://github.com/cleanlab/cleanlab) ⭐ 11,670 | 🐛 124 | 🌐 Python | 📅 2026-01-13 - The standard data-centric AI package for data quality and machine learning with messy, real-world data and labels.
...
* [PaddlePaddle](https://github.com/PaddlePaddle/Paddle) ⭐ 24,102 | 🐛 1,482 | 🌐 C++ | 📅 2026-09-22 - PArallel Distributed Deep LEarning.
...
* [Distributed](https://github.com/dask/distributed) ⭐ 1,693 | 🐛 1,520 | 🌐 Python | 📅 2026-09-22 - Distributed computation in Python.
...
* [mlflow](https://github.com/mlflow/mlflow) ⭐ 28,105 | 🐛 2,137 | 🌐 Python | 📅 2026-09-22 - Open source platform for the machine learning lifecycle.
* [dvc](https://github.com/iterative/dvc) ⭐ 15,882 | 🐛 213 | 🌐 Python | 📅 2026-09-21 - Data Version Control | Git for Data & Models | ML Experiments Management.
...
* [envd](https://github.com/tensorchord/envd) ⭐ 2,234 | 🐛 139 | 🌐 Go | 📅 2026-07-25 - 🏕️ machine learning development environment for data science and AI/ML engineering teams.
* [Neptune](https://neptune.ai) - A lightweight ML experiment tracking, results visualization, and management tool.

## Data Validation

* [great\_expectations](https://github.com/great-expectations/great_expectations) ⭐ 11,830 | 🐛 66 | 🌐 Python | 📅 2026-09-22 - Always know what to expect from your data.
* [evidently](https://github.com/evidentlyai/evidently) ⭐ 7,934 | 🐛 312 | 🌐 Jupyter Notebook | 📅 2026-09-11 - Evaluate and monitor ML models from validation to production.
* [pandera](https://github.com/unionai-oss/pandera) ⭐ 4,463 | 🐛 450 | 🌐 Python | 📅 2026-09-22 - A lightweight, flexible, and expressive statistical data testing library.
...
* [DataComPy](https://github.com/capitalone/datacompy) ⭐ 659 | 🐛 8 | 🌐 Python | 📅 2026-09-21- A library to compare Pandas, Polars, and Spark data frames. It provides stats and lets users adjust for match accuracy.
...
* [alibi-detect](https://github.com/SeldonIO/alibi-detect) ⭐ 2,549 | 🐛 147 | 🌐 Jupyter Notebook | 📅 2025-12-11 - Algorithms for outlier, adversarial and drift detection.<img height="20" src="img/alibi-detect.png" alt="sklearn">
...
* [Dask](https://github.com/dask/dask) ⭐ 13,923 | 🐛 1,338 | 🌐 Python | 📅 2026-08-24 - Parallel computing with task scheduling. <img height="20" src="img/pandas_big.png" alt="pandas compatible">
* [CuPy](https://github.com/cupy/cupy) ⭐ 12,340 | 🐛 688 | 🌐 Python | 📅 2026-09-21 - NumPy-like API accelerated with CUDA.
...
* [GeoPandas](https://github.com/geopandas/geopandas) ⭐ 5,257 | 🐛 416 | 🌐 Python | 📅 2026-09-20 - Python tools for geographic data. <img height="20" src="img/pandas_big.png" alt="pandas compatible">
* [PySal](https://github.com/pysal/pysal) ⭐ 1,525 | 🐛 24 | 🌐 Python | 📅 2026-08-03 - Python Spatial Analysis Library.

## Quantum Computing

* [qiskit](https://github.com/Qiskit/qiskit) ⭐ 7,825 | 🐛 1,043 | 🌐 Python | 📅 2026-09-22 - Qiskit is an open-source SDK for working with quantum computers at the level of circuits, algorithms, and application modules.
* [cirq](https://github.com/quantumlib/Cirq) ⭐ 5,067 | 🐛 127 | 🌐 Python | 📅 2026-09-22 - A python framework for creating, editing, and invoking Noisy Intermediate Scale Quantum (NISQ) circuits.
* [PennyLane](https://github.com/XanaduAI/pennylane) ⭐ 3,475 | 🐛 436 | 🌐 Python | 📅 2026-09-22 - Quantum machine learning, automatic differentiation, and optimization of hybrid quantum-classical computations.
* [QML](https://github.com/qmlcode/qml) ⚠️ Archived - A Python Toolkit for Quantum Machine Learning.

## Conversion

* [ONNX](https://github.com/onnx/onnx) ⭐ 21,518 | 🐛 238 | 🌐 Python | 📅 2026-09-22 - Open Neural Network Exchange.
...
* [treelite](https://github.com/dmlc/treelite) ⭐ 830 | 🐛 20 | 🌐 C++ | 📅 2026-09-21 - Universal model exchange and serialization format for decision tree forests.
