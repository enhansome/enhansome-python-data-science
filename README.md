...
* [dlib](https://github.com/davisking/dlib) ⭐ 14,445 | 🐛 39 | 🌐 C++ | 📅 2026-09-23 - Toolkit for making real-world machine learning and data analysis applications in C++ (Python bindings).
* [PyCaret](https://github.com/pycaret/pycaret) ⭐ 9,844 | 🐛 34 | 🌐 Python | 📅 2026-07-23 - An open-source, low-code machine learning library in Python.  <img height="20" src="img/R_big.png" alt="R inspired lib">
...
* [mlpack](https://github.com/mlpack/mlpack) ⭐ 5,709 | 🐛 14 | 🌐 C++ | 📅 2026-09-17 - A scalable C++ machine learning library (Python bindings).
* [cuML](https://github.com/rapidsai/cuml) ⭐ 5,288 | 🐛 808 | 🌐 Python | 📅 2026-09-23 - RAPIDS Machine Learning Library. <img height="20" src="img/sklearn_big.png" alt="sklearn"> <img height="20" src="img/gpu_big.png" alt="GPU accelerated">
* [MLxtend](https://github.com/rasbt/mlxtend) ⭐ 5,176 | 🐛 141 | 🌐 Python | 📅 2026-09-18 - Extension and helper modules for Python's data analysis and machine learning libraries. <img height="20" src="img/sklearn_big.png" alt="sklearn">
...
* [pyGAM](https://github.com/dswah/pyGAM) ⭐ 1,016 | 🐛 237 | 🌐 Python | 📅 2026-04-21 - Generalized Additive Models in Python.
...
* [Reproducible Experiment Platform (REP)](https://github.com/yandex/rep) ⭐ 699 | 🐛 34 | 🌐 Jupyter Notebook | 📅 2024-07-31 - Machine Learning toolbox for Humans. <img height="20" src="img/sklearn_big.png" alt="sklearn">
...
* [XGBoost](https://github.com/dmlc/xgboost) ⭐ 28,788 | 🐛 431 | 🌐 C++ | 📅 2026-09-23 - Scalable, Portable, and Distributed Gradient Boosting. <img height="20" src="img/sklearn_big.png" alt="sklearn"> <img height="20" src="img/gpu_big.png" alt="GPU accelerated">
* [LightGBM](https://github.com/Microsoft/LightGBM) ⭐ 18,806 | 🐛 521 | 🌐 C++ | 📅 2026-09-23 - A fast, distributed, high-performance gradient boosting. <img height="20" src="img/sklearn_big.png" alt="sklearn"> <img height="20" src="img/gpu_big.png" alt="GPU accelerated">
* [CatBoost](https://github.com/catboost/catboost) ⭐ 9,115 | 🐛 724 | 🌐 C++ | 📅 2026-09-23 - An open-source gradient boosting on decision trees library. <img height="20" src="img/sklearn_big.png" alt="sklearn"> <img height="20" src="img/gpu_big.png" alt="GPU accelerated">
...
* [PyTorch](https://github.com/pytorch/pytorch) ⭐ 103,210 | 🐛 17,569 | 🌐 Python | 📅 2026-09-23 - Tensors and Dynamic neural networks in Python with strong GPU acceleration. <img height="20" src="img/pytorch_big2.png" alt="PyTorch based/compatible">
* [pytorch-lightning](https://github.com/Lightning-AI/lightning) ⭐ 31,359 | 🐛 1,088 | 🌐 Python | 📅 2026-09-21 - PyTorch Lightning is just organized PyTorch. <img height="20" src="img/pytorch_big2.png" alt="PyTorch based/compatible">
...
* [TensorFlow](https://github.com/tensorflow/tensorflow) ⭐ 200,268 | 🐛 3,388 | 🌐 C++ | 📅 2026-09-23 - Computation using data flow graphs for scalable machine learning by Google. <img height="20" src="img/tf_big2.png" alt="sklearn">
* [Ludwig](https://github.com/uber/ludwig) ⭐ 11,764 | 🐛 1 | 🌐 Python | 📅 2026-09-21 - A toolbox that allows one to train and test deep learning models without the need to write code. <img height="20" src="img/tf_big2.png" alt="sklearn">
...
* [tensorflow-upstream](https://github.com/ROCmSoftwarePlatform/tensorflow-upstream) ⭐ 706 | 🐛 95 | 🌐 C++ | 📅 2026-09-23 - TensorFlow ROCm port. <img height="20" src="img/tf_big2.png" alt="sklearn"> <img height="20" src="img/amd_big.png" alt="Possible to run on AMD GPU">
...
* [JAX](https://github.com/google/jax) ⭐ 36,330 | 🐛 2,591 | 🌐 Python | 📅 2026-09-23 - Composable transformations of Python+NumPy programs: differentiate, vectorize, JIT to GPU/TPU, and more.
* [FLAX](https://github.com/google/flax) ⭐ 7,331 | 🐛 524 | 🌐 Jupyter Notebook | 📅 2026-09-23 - A neural network library for JAX that is designed for flexibility.
* [Optax](https://github.com/google-deepmind/optax) ⭐ 2,341 | 🐛 127 | 🌐 Python | 📅 2026-09-14 - A gradient processing and optimization library for JAX.
...
* [transformers](https://github.com/huggingface/transformers) ⭐ 166,570 | 🐛 2,391 | 🌐 Python | 📅 2026-09-23 - State-of-the-art Machine Learning for Pytorch, TensorFlow, and JAX. <img height="20" src="img/pytorch_big2.png" alt="PyTorch based/compatible"> <img height="20" src="img/tf_big2.png" alt="sklearn">
* [Caffe](https://github.com/BVLC/caffe) ⭐ 34,552 | 🐛 1,175 | 🌐 C++ | 📅 2024-07-31 - A fast open framework for deep learning.
* [autograd](https://github.com/HIPS/autograd) ⭐ 7,532 | 🐛 188 | 🌐 Python | 📅 2026-09-21 - Efficiently computes derivatives of numpy code.
...
* [AutoGluon](https://github.com/awslabs/autogluon) ⭐ 10,742 | 🐛 382 | 🌐 Python | 📅 2026-09-23 - AutoML for Image, Text, Tabular, Time-Series, and MultiModal Data.
...
* [NLTK](https://github.com/nltk/nltk) ⭐ 14,724 | 🐛 258 | 🌐 Python | 📅 2026-09-23 -  Modules, data sets, and tutorials supporting research and development in Natural Language Processing.
...
* [KerasNLP](https://github.com/keras-team/keras-nlp) ⭐ 990 | 🐛 256 | 🌐 Python | 📅 2026-09-23 - Modular Natural Language Processing workflows with Keras. <img height="20" src="img/keras_big.png" alt="Keras based/compatible">
...
* [librosa](https://github.com/librosa/librosa) ⭐ 8,623 | 🐛 51 | 🌐 Python | 📅 2026-09-21 - Python library for audio and music analysis.
* [aubio](https://github.com/aubio/aubio) ⭐ 3,757 | 🐛 160 | 🌐 C | 📅 2026-04-10 - A library for audio and music analysis.
* [Essentia](https://github.com/MTG/essentia) ⭐ 3,739 | 🐛 439 | 🌐 C++ | 📅 2026-09-21 - Library for audio and music analysis, description, and synthesis.
* [torchaudio](https://github.com/pytorch/audio) ⭐ 2,943 | 🐛 340 | 🌐 Python | 📅 2026-09-23 - An audio library for PyTorch. <img height="20" src="img/pytorch_big2.png" alt="PyTorch based/compatible">
* [madmom](https://github.com/CPJKU/madmom) ⭐ 1,714 | 🐛 81 | 🌐 Python | 📅 2026-03-20 - Python audio and music signal processing library.
...
* [OpenCV](https://github.com/opencv/opencv) ⭐ 90,950 | 🐛 2,774 | 🌐 C++ | 📅 2026-09-23 - Open Source Computer Vision Library.
* [torchvision](https://github.com/pytorch/vision) ⭐ 17,926 | 🐛 1,225 | 🌐 Python | 📅 2026-09-23 - Datasets, Transforms, and Models specific to Computer Vision. <img height="20" src="img/pytorch_big2.png" alt="PyTorch based/compatible">
...
* [scikit-image](https://github.com/scikit-image/scikit-image) ⭐ 6,595 | 🐛 952 | 🌐 Python | 📅 2026-09-23 - Image Processing SciKit (Toolbox for SciPy).
...
* [sktime](https://github.com/alan-turing-institute/sktime) ⭐ 10,039 | 🐛 2,516 | 🌐 Python | 📅 2026-09-23 - A unified framework for machine learning with time series. <img height="20" src="img/sklearn_big.png" alt="sklearn">
* [darts](https://github.com/unit8co/darts) ⭐ 9,526 | 🐛 221 | 🌐 Python | 📅 2026-09-23 - A python library for easy manipulation and forecasting of time series.
* [statsforecast](https://github.com/Nixtla/statsforecast) ⭐ 4,914 | 🐛 151 | 🌐 Python | 📅 2026-09-21 - Lightning fast forecasting with statistical and econometric models.
* [neuralforecast](https://github.com/Nixtla/neuralforecast) ⭐ 4,276 | 🐛 12 | 🌐 Python | 📅 2026-09-23 - Scalable machine learning-based time series forecasting.
...
* [mlforecast](https://github.com/Nixtla/mlforecast) ⭐ 1,281 | 🐛 21 | 🌐 Python | 📅 2026-09-23 - Scalable machine learning-based time series forecasting.
...
* [Stable Baselines3](https://github.com/DLR-RM/stable-baselines3) ⭐ 13,843 | 🐛 89 | 🌐 Python | 📅 2026-09-09 - A set of improved implementations of reinforcement learning algorithms based on OpenAI Baselines.
* [Gymnasium](https://github.com/Farama-Foundation/Gymnasium) ⭐ 12,572 | 🐛 91 | 🌐 Python | 📅 2026-09-21 - An API standard for single-agent reinforcement learning environments, with popular reference environments and related utilities (formerly [Gym](https://github.com/openai/gym) ⚠️ Archived).
* [Tianshou](https://github.com/thu-ml/tianshou/#comprehensive-functionality) ⭐ 10,989 | 🐛 142 | 🌐 Python | 📅 2026-04-03 - An elegant PyTorch deep reinforcement learning library. <img height="20" src="img/pytorch_big2.png" alt="PyTorch based/compatible">
...
* [cleanrl](https://github.com/vwxyzjn/cleanrl) ⭐ 10,448 | 🐛 113 | 🌐 Python | 📅 2026-04-20 - High-quality single file implementation of Deep Reinforcement Learning algorithms with research-friendly features (PPO, DQN, C51, DDPG, TD3, SAC, PPG).
...
* [Imitation](https://github.com/HumanCompatibleAI/imitation) ⭐ 1,799 | 🐛 99 | 🌐 Python | 📅 2025-01-07 - Clean PyTorch implementations of imitation and reward learning algorithms. <img height="20" src="img/pytorch_big2.png" alt="PyTorch based/compatible">
* [d3rlpy](https://github.com/takuseno/d3rlpy) ⭐ 1,684 | 🐛 59 | 🌐 Python | 📅 2025-09-10 - An offline deep reinforcement learning library.
* [EnvPool](https://github.com/sail-sg/envpool) ⭐ 1,521 | 🐛 16 | 🌐 C++ | 📅 2026-09-15 - C++-based high-performance parallel environment execution engine (vectorized env) for general RL environments.
...
* [pytorch\_geometric](https://github.com/rusty1s/pytorch_geometric) ⭐ 24,096 | 🐛 1,346 | 🌐 Python | 📅 2026-09-01 - Geometric Deep Learning Extension Library for PyTorch. <img height="20" src="img/pytorch_big2.png" alt="PyTorch based/compatible">
* [TRL](https://github.com/huggingface/trl) ⭐ 19,371 | 🐛 274 | 🌐 Python | 📅 2026-09-23 - Train transformer language models with reinforcement learning.
...
* [TensorFlow GNN](https://github.com/tensorflow/gnn) ⭐ 1,546 | 🐛 43 | 🌐 Python | 📅 2026-09-09 - A library to build Graph Neural Networks on the TensorFlow platform. <img height="20" src="img/tf_big2.png" alt="TensorFlow">
...
* [Networkx](https://github.com/networkx/networkx) ⭐ 17,279 | 🐛 312 | 🌐 Python | 📅 2026-09-23 - Network Analysis in Python.
* [Rustworkx](https://github.com/Qiskit/rustworkx) ⭐ 1,759 | 🐛 136 | 🌐 Rust | 📅 2026-09-23 - A high performance Python graph library implemented in Rust.
...
* [RecBole](https://github.com/RUCAIBox/RecBole) ⭐ 4,567 | 🐛 359 | 🌐 Python | 📅 2025-02-24 - A unified, comprehensive and efficient recommendation library. <img height="20" src="img/pytorch_big2.png" alt="PyTorch based/compatible">
...
* [pgmpy](https://github.com/pgmpy/pgmpy) ⭐ 3,336 | 🐛 638 | 🌐 Python | 📅 2026-09-23 - A python library for working with Probabilistic Graphical Models.
* [pyAgrum](https://agrum.gitlab.io/) - A GRaphical Universal Modeler.

## Probabilistic Methods

* [PyMC](https://github.com/pymc-devs/pymc) ⭐ 9,770 | 🐛 510 | 🌐 Python | 📅 2026-09-21 - Bayesian Stochastic Modelling in Python.
...
* [GPyTorch](https://github.com/cornellius-gp/gpytorch) ⭐ 3,917 | 🐛 424 | 🌐 Python | 📅 2026-07-10 - A highly efficient and modular implementation of Gaussian Processes in PyTorch. <img height="20" src="img/pytorch_big2.png" alt="PyTorch based/compatible">
...
* [skpro](https://github.com/alan-turing-institute/skpro) ⭐ 336 | 🐛 266 | 🌐 Python | 📅 2026-09-23 - Supervised domain-agnostic prediction framework for probabilistic modelling by [The Alan Turing Institute](https://www.turing.ac.uk/). <img height="20" src="img/sklearn_big.png" alt="sklearn">
...
* [Netron](https://github.com/lutzroeder/Netron) ⭐ 33,516 | 🐛 18 | 🌐 JavaScript | 📅 2026-09-22 - Visualizer for deep learning and machine learning models (no Python code, but visualizes models from most Python Deep Learning frameworks).
* [shap](https://github.com/slundberg/shap) ⭐ 25,777 | 🐛 983 | 🌐 Jupyter Notebook | 📅 2026-09-21 - A unified approach to explain the output of any machine learning model. <img height="20" src="img/sklearn_big.png" alt="sklearn">
...
* [yellowbrick](https://github.com/DistrictDataLabs/yellowbrick) ⭐ 4,405 | 🐛 117 | 🌐 Python | 📅 2025-02-19 - Visual analysis and diagnostic tools to facilitate machine learning model selection. <img height="20" src="img/sklearn_big.png" alt="sklearn">
...
* [Optuna](https://github.com/optuna/optuna) ⭐ 14,839 | 🐛 23 | 🌐 Python | 📅 2026-09-22 - A hyperparameter optimization framework.
...
* [BoTorch](https://github.com/pytorch/botorch) ⭐ 3,601 | 🐛 94 | 🌐 Jupyter Notebook | 📅 2026-09-23 - Bayesian optimization in PyTorch. <img height="20" src="img/pytorch_big2.png" alt="PyTorch based/compatible">
* [pymoo](https://github.com/anyoptimization/pymoo) ⭐ 2,963 | 🐛 0 | 🌐 Python | 📅 2026-07-07 - Multi-objective Optimization in Python.
...
* [pycma](https://github.com/CMA-ES/pycma?tab=readme-ov-file) ⭐ 1,358 | 🐛 94 | 🌐 Jupyter Notebook | 📅 2026-09-15 - Python implementation of CMA-ES.
* [SMAC3](https://github.com/automl/SMAC3) ⭐ 1,250 | 🐛 112 | 🌐 Python | 📅 2026-09-23 - Sequential Model-based Algorithm Configuration.
...
* [tsfresh](https://github.com/blue-yonder/tsfresh) ⭐ 9,430 | 🐛 74 | 🌐 Jupyter Notebook | 📅 2026-07-06 - Automatic extraction of relevant features from time series. <img height="20" src="img/sklearn_big.png" alt="sklearn">
* [Featuretools](https://github.com/Featuretools/featuretools) ⭐ 7,684 | 🐛 171 | 🌐 Python | 📅 2026-09-11 - Automated feature engineering.
* [Feature Engine](https://github.com/feature-engine/feature_engine) ⭐ 2,281 | 🐛 105 | 🌐 Python | 📅 2026-09-19 - Feature engineering package with sklearn-like functionality. <img height="20" src="img/sklearn_big.png" alt="sklearn">
...
* [tubular](https://github.com/azukds/tubular) ⭐ 108 | 🐛 71 | 🌐 Python | 📅 2026-09-23 - Collection of scikit-learn compatible transformers written in [narwhals](https://github.com/narwhals-dev/narwhals) ⭐ 1,723 | 🐛 261 | 🌐 Python | 📅 2026-09-23, which can accept either polars/pandas inputs and utilise the chosen library under the hood. <img height="20" src="img/sklearn_big.png" alt="sklearn"><img height="20" src="img/pandas_big.png" alt="pandas compatible">
...
* [Matplotlib](https://github.com/matplotlib/matplotlib) ⭐ 23,254 | 🐛 1,487 | 🌐 Python | 📅 2026-09-23 - Plotting with Python.
* [seaborn](https://github.com/mwaskom/seaborn) ⭐ 14,039 | 🐛 236 | 🌐 Python | 📅 2026-07-06 - Statistical data visualization using matplotlib.
...
* [Bokeh](https://github.com/bokeh/bokeh) ⭐ 20,459 | 🐛 845 | 🌐 Python | 📅 2026-09-23 - Interactive Web Plotting for Python.
* [pyecharts](https://github.com/pyecharts/pyecharts) ⭐ 15,772 | 🐛 4 | 🌐 Python | 📅 2026-08-04 - Migrated from [Echarts](https://github.com/apache/echarts) ⭐ 67,383 | 🐛 1,494 | 🌐 TypeScript | 📅 2026-09-16, a charting and visualization library, to Python's interactive visual drawing library.<img height="20" src="img/pyecharts.png" alt="pyecharts"> <img height="20" src="img/echarts.png" alt="echarts">
...
* [geemap](https://github.com/giswqs/geemap) ⭐ 4,031 | 🐛 58 | 🌐 Python | 📅 2026-09-22 - Python package for interactive mapping with Google Earth Engine (GEE)
...
* [HoloViews](https://github.com/ioam/holoviews) ⭐ 2,910 | 🐛 1,021 | 🌐 Python | 📅 2026-09-23 - Stop plotting your data - annotate your data and let it visualize itself.
...
* [gradio](https://github.com/gradio-app/gradio) ⭐ 43,608 | 🐛 105 | 🌐 Python | 📅 2026-09-23 - Create UIs for your machine learning model in Python in 3 minutes.
* [Vizro](https://github.com/mckinsey/vizro) ⭐ 3,798 | 🐛 36 | 🌐 Python | 📅 2026-09-23 - A toolkit for creating modular data visualization applications.
* [Deepnote](https://github.com/deepnote/deepnote) ⭐ 3,008 | 🐛 35 | 🌐 TypeScript | 📅 2026-09-23 - Deepnote is a drop-in replacement for Jupyter with an AI-first design, sleek UI, new blocks, and native data integrations. Use Python, R, and SQL locally in your favorite IDE, then scale to Deepnote cloud for real-time collaboration, Deepnote agent, and deployable data apps.
* [streamsync](https://github.com/streamsync-cloud/streamsync) ⭐ 1,449 | 🐛 12 | 🌐 Python | 📅 2026-09-23 - No-code in the front, Python in the back. An open-source framework for creating data apps.
...
* [Pandas Profiling](https://github.com/pandas-profiling/pandas-profiling) ⭐ 13,713 | 🐛 329 | 🌐 Python | 📅 2026-09-11 - Create HTML profiling reports from pandas DataFrame objects. <img height="20" src="img/pandas_big.png" alt="pandas compatible">
* [statsmodels](https://github.com/statsmodels/statsmodels) ⭐ 11,647 | 🐛 2,822 | 🌐 Python | 📅 2026-09-23 - Statistical modeling and econometrics in Python.
* [Alphalens](https://github.com/quantopian/alphalens) ⭐ 4,452 | 🐛 50 | 🌐 Jupyter Notebook | 📅 2024-02-12 - Performance analysis of predictive (alpha) stock factors.
...
* [polars](https://github.com/pola-rs/polars) ⭐ 39,849 | 🐛 2,934 | 🌐 Rust | 📅 2026-09-23 - A fast multi-threaded, hybrid-out-of-core DataFrame library.
* [pandas\_profiling](https://github.com/pandas-profiling/pandas-profiling) ⭐ 13,713 | 🐛 329 | 🌐 Python | 📅 2026-09-11 - Create HTML profiling reports from pandas DataFrame objects
* [modin](https://github.com/modin-project/modin) ⭐ 10,389 | 🐛 715 | 🌐 Python | 📅 2026-02-10 - Speed up your pandas workflows by changing a single line of code. <img height="20" src="img/pandas_big.png" alt="pandas compatible">
* [cuDF](https://github.com/rapidsai/cudf) ⭐ 9,759 | 🐛 1,353 | 🌐 C++ | 📅 2026-09-23 - GPU DataFrame Library. <img height="20" src="img/pandas_big.png" alt="pandas compatible"> <img height="20" src="img/gpu_big.png" alt="GPU accelerated">
...
* [xarray](https://github.com/pydata/xarray) ⭐ 4,200 | 🐛 1,457 | 🌐 Python | 📅 2026-09-23 - Xarray combines the best features of NumPy and pandas for multidimensional data selection by supplementing numerical axis labels with named dimensions for more intuitive, concise, and less error-prone indexing routines.
...
* [Hamilton](https://github.com/DAGWorks-Inc/hamilton) ⭐ 2,598 | 🐛 175 | 🌐 Jupyter Notebook | 📅 2026-09-23 - A microframework for dataframe generation that applies Directed Acyclic Graphs specified by a flow of lazily evaluated Python functions.
* [pyjanitor](https://github.com/ericmjl/pyjanitor) ⭐ 1,500 | 🐛 149 | 🌐 Python | 📅 2026-09-23 - Clean APIs for data cleaning. <img height="20" src="img/pandas_big.png" alt="pandas compatible">
...
* [cleanlab](https://github.com/cleanlab/cleanlab) ⭐ 11,671 | 🐛 124 | 🌐 Python | 📅 2026-01-13 - The standard data-centric AI package for data quality and machine learning with messy, real-world data and labels.
...
* [PaddlePaddle](https://github.com/PaddlePaddle/Paddle) ⭐ 24,105 | 🐛 1,482 | 🌐 C++ | 📅 2026-09-23 - PArallel Distributed Deep LEarning.
...
* [Distributed](https://github.com/dask/distributed) ⭐ 1,693 | 🐛 1,520 | 🌐 Python | 📅 2026-09-23 - Distributed computation in Python.
...
* [mlflow](https://github.com/mlflow/mlflow) ⭐ 28,119 | 🐛 2,141 | 🌐 Python | 📅 2026-09-23 - Open source platform for the machine learning lifecycle.
* [dvc](https://github.com/iterative/dvc) ⭐ 15,884 | 🐛 213 | 🌐 Python | 📅 2026-09-21 - Data Version Control | Git for Data & Models | ML Experiments Management.
...
* [great\_expectations](https://github.com/great-expectations/great_expectations) ⭐ 11,835 | 🐛 67 | 🌐 Python | 📅 2026-09-23 - Always know what to expect from your data.
* [evidently](https://github.com/evidentlyai/evidently) ⭐ 7,935 | 🐛 313 | 🌐 Jupyter Notebook | 📅 2026-09-11 - Evaluate and monitor ML models from validation to production.
* [pandera](https://github.com/unionai-oss/pandera) ⭐ 4,465 | 🐛 451 | 🌐 Python | 📅 2026-09-22 - A lightweight, flexible, and expressive statistical data testing library.
...
* [DataComPy](https://github.com/capitalone/datacompy) ⭐ 659 | 🐛 8 | 🌐 Python | 📅 2026-09-23- A library to compare Pandas, Polars, and Spark data frames. It provides stats and lets users adjust for match accuracy.
...
* [Dask](https://github.com/dask/dask) ⭐ 13,924 | 🐛 1,340 | 🌐 Python | 📅 2026-08-24 - Parallel computing with task scheduling. <img height="20" src="img/pandas_big.png" alt="pandas compatible">
* [CuPy](https://github.com/cupy/cupy) ⭐ 12,340 | 🐛 687 | 🌐 Python | 📅 2026-09-23 - NumPy-like API accelerated with CUDA.
...
* [GeoPandas](https://github.com/geopandas/geopandas) ⭐ 5,259 | 🐛 417 | 🌐 Python | 📅 2026-09-20 - Python tools for geographic data. <img height="20" src="img/pandas_big.png" alt="pandas compatible">
* [PySal](https://github.com/pysal/pysal) ⭐ 1,526 | 🐛 24 | 🌐 Python | 📅 2026-08-03 - Python Spatial Analysis Library.

## Quantum Computing

* [qiskit](https://github.com/Qiskit/qiskit) ⭐ 7,828 | 🐛 1,028 | 🌐 Python | 📅 2026-09-23 - Qiskit is an open-source SDK for working with quantum computers at the level of circuits, algorithms, and application modules.
* [cirq](https://github.com/quantumlib/Cirq) ⭐ 5,068 | 🐛 126 | 🌐 Python | 📅 2026-09-22 - A python framework for creating, editing, and invoking Noisy Intermediate Scale Quantum (NISQ) circuits.
* [PennyLane](https://github.com/XanaduAI/pennylane) ⭐ 3,476 | 🐛 437 | 🌐 Python | 📅 2026-09-23 - Quantum machine learning, automatic differentiation, and optimization of hybrid quantum-classical computations.
* [QML](https://github.com/qmlcode/qml) ⚠️ Archived - A Python Toolkit for Quantum Machine Learning.

## Conversion

* [ONNX](https://github.com/onnx/onnx) ⭐ 21,520 | 🐛 239 | 🌐 Python | 📅 2026-09-22 - Open Neural Network Exchange.
...
Read the \<a href=[https://github.com/krzjoa/awesome-python-datascience/blob/master/CONTRIBUTING.md>contribution](https://github.com/krzjoa/awesome-python-datascience/blob/master/CONTRIBUTING.md>contribution) ⭐ 3,597 | 🐛 21 | 📅 2026-04-13 guideline</a>.
